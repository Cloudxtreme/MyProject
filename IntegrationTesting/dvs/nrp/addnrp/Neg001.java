...
/**
 * DESCRIPTION:Add a network resource pool with limit set to 0 or -2<BR>
 * TARGET:VC<BR>
 * SETUP:<BR>
 * 1.create the dvs<BR>
 * 2.enable netiorm<BR>
...
public class Neg001 extends TestBase implements IDataDrivenTest
{
   ...
   @Test(description = "Add a network resource pool with limit set to 0 or -2")
   public void test()
      throws Exception
   {
      try {
         ...
         Long limit = data.getLong(DVSTestConstants.NRP_LIMIT);
   ...
   {
      setTestDescription("Add a network resource pool with limit set to 0 or -2");
   }
