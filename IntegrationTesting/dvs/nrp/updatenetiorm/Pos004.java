...
public class Pos004 extends TestBase
{
    ...
    */
   @Override
   @Test(description = "Configure a NRP for ft")
   public void test()
      throws Exception
   {
      ...
      throws Exception
   {
      ...
      nrp = idvs.extractNetworkResourcePool(dvsMor, DVSTestConstants.NRP_FT);
   ...
   {
      setTestDescription("Configure a NRP for ft");
   }
