...
public class Pos005 extends TestBase
{
    ...
    */
   @Override
   @Test(description = "Configure a NRP for nfs")
   public void test()
      throws Exception
   {
      ...
      throws Exception
   {
      ...
      nrp = idvs.extractNetworkResourcePool(dvsMor, DVSTestConstants.NRP_NFS);

      // assert if nrp is null
      Assert.assertNotNull(nrp, "Could not find nrp for nfs");
   ...
   {
      setTestDescription("Configure a NRP for nfs");
   }
