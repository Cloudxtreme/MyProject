...
/**
 * Configure a NRP with limit as negative value
 */
public class Pos007 extends TestBase
{
    ...
    */
   @Override
   @Test(description = "Configure a NRP with limit as negative value")
   public void test()
      throws Exception
   {
      ...
      throws Exception
   {
      ...
      Assert.assertNotNull(nrp, "Could not find nrp for vm");
   ...
   {
      setTestDescription("Configure a NRP with limit as negative value");
   }
