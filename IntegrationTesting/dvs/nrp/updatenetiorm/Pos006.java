...
/**
 * Configure a NRP for management
 */
public class Pos006 extends TestBase
{
    ...
    */
   @Override
   @Test(description = "Configure a NRP for management")
   public void test()
      throws Exception
   {
      ...
      throws Exception
   {
      ...
      nrp = idvs.extractNetworkResourcePool(dvsMor, DVSTestConstants.NRP_MGMT);

      // assert if nrp is null
      Assert.assertNotNull(nrp, "Could not find nrp for ft");
   ...
   {
      setTestDescription("Configure a NRP for management");
   }
