 ...
 * port. The device is of type VirtualE1000, the backing is of type DVPort
 * backing and the port connection is a DVPort connection.
 */
public class Pos003 extends ReconfigureVMBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription(" Reconfigure a VM on a standalone host to connect"
               ...
               + " VirtualE1000, the  backing is of type DVPort backing"
