 ...
 * DVPort. Build DVPortConnection with invalid DVPortKey. The device is of type
 * VirtualPCNet32,the backing is of type DVPort backing and the port connection
 * is a DVPort connection.
 */
public class Neg003 extends VMopsBase
{
   /*
   ...
   public void setTestDescription()
   {
      setTestDescription("Reconfigure a VM on a Standalone host to connect to"
               ...
               + " VirtualPCNet32.DVPortconnection with invalid DVPortKey.");
   }
    ...
    * DVPortKey. 4. Create the Default VMConfigSpec.
    * 
