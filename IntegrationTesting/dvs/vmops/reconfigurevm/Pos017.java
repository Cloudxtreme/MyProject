...
/**
 * Reconfigure 4 VM's on a standalone host to connect to an existing
 * earlyBinding DVPortgroup,containing 4 unused ports. The device is of type
 * VirtualPCNete32, the backing is of type DVPort backing and the port
 * connection is a DVPortgroup connection.
 */
public class Pos017 extends VMopsBase
{
   /*
   ...
   {
      setTestDescription(" Reconfigure 4 VM's on a standalone host to connect"
               + " to an existing earlyBinding DVPortgroup containing 4 unused "
               + "ports. The device is of type VirtualPCNet32");
   }
    ...
    */
   @Override
   @Test(description = " Reconfigure 4 VM's on a standalone host to connect"
               + " to an existing earlyBinding DVPortgroup containing 4 unused "
               + "ports. The device is of type VirtualPCNet32")
   public void test()
      throws Exception
