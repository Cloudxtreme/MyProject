 ...
 * earlyBinding DVPortgroup. The device is of type VirtualVmxNet2, the backing
 * is of type DVPort backing and the port connection is a DVPortgroup
 * connection.
 */
public class Pos012 extends ReconfigureVMBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription(" Reconfigure a VM on a standalone host to connect"
               ...
               + "device is of type VirtualVmxNet2, the  backing is of "
               + "type DVPort backing and the port connection is a "
