...
public class netstackTest extends TestBase implements IDataDrivenTest
{

   private Object     netstackTestFramework = null;
   ...
   public void test() throws Exception
   {
      ...
      try {
         Method method = testFrameworkClass.getDeclaredMethod("execute",
               List.class);
         method.invoke(this.netstackTestFramework, stepList);
   ...
   public void initializeTest() throws Exception
   {
      if (DVSUtil.getvDsVersion().compareTo(DVSTestConstants.VDS_VERSION_55) < 0) {
          log.error("cannot execute multi net stack test cases " +
              "prior to dvs version 5.5.0");
          throw new Exception("cannot execute multi net stack test cases " +
              "prior to dvs version 5.5.0");
      }
      ...
      netstackTestFramework = constructor.newInstance(this.connectAnchor,
            beanPath);
   }
