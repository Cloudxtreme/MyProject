 ...
 * valid config version string - DVSConfigSpec.name to
 * "abcdefghijklmnopqrstuvwxyzabcde"
 */
public class Pos003 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS by setting the \n"
               ...
               + "  - DVSConfigSpec.name to 'abcdefghijklmnopqrstuvwxyzabcde'.");
   }
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  this.deltaConfigSpec.setName("abcdefghijklmnopqrstuvwxyzabcde");
                  status = true;
               } else {
