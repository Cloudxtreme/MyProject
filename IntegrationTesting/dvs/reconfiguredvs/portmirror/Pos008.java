...
public class Pos008 extends PortMirrorTestBase {
	...
	public void test() throws Exception {
		...
		if (target != null) {
			...
			target.getVspanSession().getDestinationPort().getIpAddress().clear();
         target.getVspanSession().getDestinationPort().getIpAddress().addAll(com.vmware.vcqa.util.TestUtil.arrayToVector(dstIPs));
		} else {
			assertTrue(false, "fail to create session object!");
		}
