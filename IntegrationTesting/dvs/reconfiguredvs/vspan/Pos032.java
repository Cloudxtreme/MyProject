...
/**
 * DESCRIPTION:<br>
 * Move a port which is used as Rx source to a PG with promiscuous enabled.
 **/
public class Pos032 extends VspanTestBase
{
   String dvPort;
   String pgKey;
   ...
   public void test()
      throws Exception
   {
      log.info("Move ports {} to PG {} Should be successful ...", dvPort, pgKey);
      assertTrue(vmwareDvs.movePort(dvsMor, new String[] { dvPort }, pgKey),
               "Failed to move DVPort");
   }
