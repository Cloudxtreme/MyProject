...
/**
 * DESCRIPTION:<br>
 * Edit a VSPAN session in a DVS by providing invalid uplink port name as
 * destination.
 */
public class Neg022 extends VspanTestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Edit a VSPAN session in a DVS by providing "
               + "invalid uplink port name as destination.");
   }
