...
/**
 * DESCRIPTION:<br>
 * Move a port which is used as destination to a PG with promiscuous enabled and
 * expect that VspanPortMoveFault is thrown.
 **/
public class Neg026 extends VspanTestBase
{
   String dvPort;
   String pgKey;
   ...
   @Test(description = "Move a port which is used as destination to a PG with promiscuous "
