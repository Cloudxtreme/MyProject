...
/**
 * DESCRIPTION:<br>
 * Enable promiscuous mode to a DVPort which is mirrored for tx source and
 * expect VspanPortPromiscChangeFault exception.
 **/
public class Neg030 extends VspanTestBase
{
