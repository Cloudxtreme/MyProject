 ...
 * valid config version string - DVSConfigSpec.name to min name"
 */
public class Pos072 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS by setting the \n"
               ...
               + "  - DVSConfigSpec.name to min name[\"\"]");
   }
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  this.deltaConfigSpec.setName("a");
                  status = true;
               } else {
