 ...
 * number of elements more than the number of pnics being added({uplink1, ..
 ...
 */
public class Pos019 extends CreateDVSTestBase
{
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  this.deltaConfigSpec.setUplinkPortPolicy(uplinkPolicyInst);
                  this.deltaConfigSpec.setMaxPorts(uplinkPortNames.length + 3);
