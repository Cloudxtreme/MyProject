...
/**
 * Reconfigure an existing DVS by setting the - DVSContactInfo.contact to
 * "Contact Reconfigure DVS- Pos011 Description"
 */
public class Pos011 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS by setting the \n"
               + " - DVSContactInfo.contact to 'Contact Reconfigure DVS- Pos011 "
               + "Description'\n");
   }
