 ...
 * number - DVSPortSetting .blocked to false - uplinkPortOrder.activeUplinkPort
 * is set to an invalid array containing an invalid uplink port name.
 */

public class Neg051 extends CreateDVSTestBase
{
   /*
      ...
      throws Exception
   {
      ...
      String[] uplinkActiveNics = new String[] { "invalidUplink1", "@#$%^&*" };
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  if (uplinkTeamingPolicy == null) {
                     ...
                     portOrderPolicy.getActiveUplinkPort().addAll(com.vmware.vcqa.util.TestUtil.arrayToVector(uplinkActiveNics));
