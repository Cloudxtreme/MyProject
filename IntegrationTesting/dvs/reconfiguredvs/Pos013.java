 ...
 * numPort - Set DVSConfigSpec.numPort to a valid equal to the number of uplink
 * ports per host - Set DVSConfigSpec.uplinkPortPolicy to an array of 32 uplink
 * elements - Set DistributedVirtualSwitchHostMemberConfigSpec.operation to ADD
...
public class Pos013 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS as follows:\n"
               ...
               + " numPort\n"
               + "  - Set DVSConfigSpec.numPort to a valid equal to the number of uplink"
               + " ports per host\n"
               + "  - Set DVSConfigSpec.uplinkPortPolicy to an array of 32 uplink "
               + "elements\n"
