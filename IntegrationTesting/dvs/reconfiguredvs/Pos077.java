 ...
 * DVSConfigSpec.maxPorts to 0 - DVSConfigSpec.uplinkPortPolicy to { A name
 * containing alphabets, numeric characters, and special characters uplink2,
 * uplink3}
 */
public class Pos077 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS by setting the \n"
               ...
               + " - DVSConfigSpec.uplinkPortPolicy to {A name containing alphabets,"
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  String[] uplinkPortNames = {
                           DVSTestConstants.NAME_ALPHA_NUMERIC_SPECIAL_CHARS,
                           "uplink2", "uplink3" };
