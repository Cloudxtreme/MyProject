 ...
 * valid config version string - DVSConfigSpec.name to a name containing
 * alphabets, numeric characters, and special
 * characters"-`~!@#$%^&*()-_=+[]\\{}|;':\",./<>?."
 */
public class Pos070 extends CreateDVSTestBase
{
   ...
   private String name = DVSTestConstants.DVPORTGROUP_VALID_NAME_31_CHARS
            + "-`~!@#$^&*()-_=+[]{}|;':\",.<>?."
            + DVSTestConstants.ALL_NUM_STRING;
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS by setting the \n"
               ...
               + "  - DVSConfigSpec.name to a name containing alphabets, numeric "
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  this.deltaConfigSpec.setName(name);
                  status = true;
               } else {
