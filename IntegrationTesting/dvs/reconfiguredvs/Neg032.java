 ...
 * selection that has a single pnicSpec with an invalid pnic key.
 */

public class Neg032 extends CreateDVSTestBase
{
   /*
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVSwitch by setting:\n "
               ...
               + "that has  a single pnicSpec with an invalid pnic key.");
   }
