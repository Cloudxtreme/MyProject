 ...
 * valid DVSwitch Mor and DVSConfigSpec.configVersion to an invalid config
 * version string.
 */
...
public class Neg006 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVSwitch by setting "
               ...
               + "DVSConfigSpec.configVersion to an invalid config version string.");
   }
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  this.deltaConfigSpec.setConfigVersion("abc");
                  status = true;
               } else {
