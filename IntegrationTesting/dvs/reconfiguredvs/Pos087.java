 ...
 * number - DVSPortSetting.blocked to false - DVSPortSetting.mtu to 0
 */

public class Pos087 extends CreateDVSTestBase
{
   /*
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  vmwareDVSConfigSpec.setMaxMtu(0);
