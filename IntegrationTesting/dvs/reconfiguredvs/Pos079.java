 ...
 * DVSConfigSpec.maxPorts to 0 - DVSConfigSpec.uplinkPortPolicy to { uplink port
 * name to single char, uplink2, uplink3}
 */
public class Pos079 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS by setting the \n"
               ...
               + " - DVSConfigSpec.uplinkPortPolicy to {with two or more words separated"
               + " by spaces");
   }
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  String[] uplinkPortNames = { "a", "uplink2", "uplink3" };
