 ...
 * valid config version string - DVSConfigSpec.name to max name"
 */
public class Pos073 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS by setting the \n"
               ...
               + "  - DVSConfigSpec.name to max name[80 characters in length]");
   }
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  this.deltaConfigSpec.setName((DVSTestConstants.DVPORTGROUP_VALID_NAME_31_CHARS
