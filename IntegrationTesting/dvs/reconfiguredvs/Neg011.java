 ...
 * string, maxPorts to a number less than numPorts and numPorts to a valid
 * number.
 */
...
public class Neg011 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVSwitch by setting "
               ...
               + "DVSConfigSpec.configVersion to a valid config version string, maxPorts"
               + " to a number less than numPorts and numPorts to a valid number.");
   }
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  this.deltaConfigSpec.setNumStandalonePorts(10);
                  status = true;
               } else {
