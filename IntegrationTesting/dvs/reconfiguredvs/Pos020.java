 ...
 * numPort - Set DVSConfigSpec.numPort to a valid number number more than the
 * number of uplink ports per host - Set DVSConfigSpec.uplinkPortPolicy to a
 * valid array that has number of elements equal to the number of pnics being
...
public class Pos020 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS as follows:\n"
               ...
               + " equal to the number of uplink ports per host.");
   }
