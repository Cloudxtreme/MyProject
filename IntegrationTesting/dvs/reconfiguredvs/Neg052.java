 ...
 * number - DVSPortSetting .blocked to false - uplinkPortOrder.standByUplinkPort
 * is set to an invalid array containing an invalid uplink port name.
 */

public class Neg052 extends CreateDVSTestBase
{
   /*
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVSwitch by setting:\n "
               ...
               + " - uplinkPortOrder.standByUplinkPort is set to an invalid array "
      ...
      throws Exception
   {
      ...
      String[] uplinkStandByNics = new String[] { "invalidUplink1", "@#$%^&*" };
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  if (uplinkTeamingPolicy == null) {
                     portOrderPolicy = DVSUtil.getPortOrderPolicy(false, null,
                              uplinkStandByNics);
                     ...
                     portOrderPolicy.getStandbyUplinkPort().addAll(com.vmware.vcqa.util.TestUtil.arrayToVector(uplinkStandByNics));
