 ...
 * valid config version string - DVSConfigSpec.description to
 * "maximal number�of characters�(i.e. 255)"
 */
public class Pos081 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS by setting the \n"
               ...
               + "  - DVSConfigSpec.description to 'maximal number�of characters�(i.e. 255)'.");
   }
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  String dvsDescription = (DVSTestConstants.DVPORTGROUP_VALID_NAME_31_CHARS
