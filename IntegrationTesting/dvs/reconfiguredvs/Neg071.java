...
public class Neg071 extends TestBase implements IDataDrivenTest
{
      ...
      throws Exception
   {
      ...
      // Get Invalid IpfixConfig parameters from data driven xml file.
    ...
    * Test
    */
   @Test(description="Data-driven test to reconfigure DistributedVirtualSwitch with various " +
         "invalid IpfixConfig parameters")
   public void test()
      throws Exception
   {
      try {
