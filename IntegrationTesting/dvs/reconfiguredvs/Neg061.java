 ...
 * string and name to WhitespaceName.
 */

public class Neg061 extends CreateDVSTestBase
{
   /*
      ...
      throws Exception
   {
      ...
      try {
         ...
         MethodFault expectedMethodFault = new InvalidName();
