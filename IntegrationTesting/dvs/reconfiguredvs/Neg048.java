 ...
 * inShapingPolicy.burstSize set to a negative number
 */

public class Neg048 extends CreateDVSTestBase
{
   /*
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVSwitch by setting:\n "
               ...
               + " - inShapingPolicy.burstSize to a negative value.");
   }
