 ...
 * "ReconfigDVS-Pos005 Description"
 */
public class Pos005 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS by setting the \n"
               ...
               + "  - DVSConfigSpec.description to 'ReconfigDVS-Pos005 Description'.");
   }
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  String dvsDescription = DVSTestConstants.DVS_RECONFIG_NAME_PREFIX
                           + "Pos005 Description";
