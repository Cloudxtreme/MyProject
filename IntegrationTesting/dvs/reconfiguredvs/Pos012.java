...
/**
 * Reconfigure an existing DVS by setting the - DVSContactInfo.name to
 * "Contact ReconfigDVS- Pos012" - DVSContactInfo.contact to
 * "Contact ReconfigDVS- Pos012 Description"
 */
public class Pos012 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS by setting the \n"
               + "- DVSContactInfo.name to 'Contact ReconfigDVS- Pos012'\n"
               + "- DVSContactInfo.contact to 'Contact ReconfigDVS- Pos012 "
               + "Description'\n");
   }
