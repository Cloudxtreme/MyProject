...
/**
 * Create a DVS with all parameters set to null
 */
...
public class Neg001 extends CreateDVSTestBase
{
   ...
   {
      super.setTestDescription("Create a DVS with all parameters set to null");
   }
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Create a DVS with all parameters set to null")
   public void test()
      throws Exception
   {
      log.info("Test Begin:");
