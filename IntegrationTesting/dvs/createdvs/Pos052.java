 ...
 * configVersion - empty string name - "Create DVS-Pos052" numPort - valid
 * number maxPort - valid number For DVPortSetting: blocked - true
 * securityPolicy set to a valid value trunkingMode - false
 */

public class Pos052 extends CreateDVSTestBase
{
