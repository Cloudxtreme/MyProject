 ...
 * string. - DVSConfigSpec.name is set to "CreateDVS-Pos020" -
 * DVSConfigSpec.numPort set to a valid number - DVSConfigSpec.uplinkPortPolicy
 * set to a valid array that is equal to the number of pnics being
 ...
 */
public class Pos020 extends CreateDVSTestBase
{
   /*
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create DVSwitch with the following parameters"
               ...
               + "- DVSConfigSpec.name is set to 'CreateDVS-Pos020',\n"
