 ...
 * DVSConfigSpec.name is set to "CreateDVS-Neg041" - DVPortSetting.blocked is
 * set to false - outShapingPolicy.enabled is set to true -
 * outShapingPolicy.burstSize is set to -1.
 */
public class Neg041 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create a DVS inside a valid folder with the"
               ...
               + "  - DVSConfigSpec.name is set to 'CreateDVS-Neg041'\n"
