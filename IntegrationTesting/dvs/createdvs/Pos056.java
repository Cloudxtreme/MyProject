 ...
 * configVersion - empty string name - "Create DVS-Pos056" numPort - valid
 * number maxPort - valid number For DVPortSetting: blocked - false
 * uplinkTeamingPolicy.notifySwitches - false uplinkTeamingPolicy.policy - true
...
public class Pos056 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create a DVSwitch inside a valid folder with"
               ...
               + "uplinkTeamingPolicy.reversePolicy - true \n"
               + "uplinkTeamingPolicy.rollingOrder - false ");
   }
