 ...
 * configVersion - empty string name - "Create DVS-Pos054" numPort - valid
 * number maxPort - valid number For DVPortSetting: blocked - false
 * failureCriteria set to a valid value notifySwitches - false reversePolicy -
 * false rollingOrder - false
 */
...
public class Pos054 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create a DVSwitch inside a valid folder with"
               ...
               + "name - 'Create DVS-Pos054'\n " + "numPort - valid number\n"
               + "maxPort - valid number\n" + "For DVPortSetting:\n"
               + "blocked - false\n" + "failureCriteria set to a valid value\n"
      ...
      log.info("Test setup Begin:");
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               failureCriteria.setSpeed(DVSUtil.getIntPolicy(false, 10));
               ...
               uplinkTeamingPolicy.setRollingOrder(DVSUtil.getBoolPolicy(false,
                        false));
               dvPort.setUplinkTeamingPolicy(uplinkTeamingPolicy);
