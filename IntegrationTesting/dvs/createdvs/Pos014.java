 ...
 * DVSConfigSpec.name is set to "CreateDVS-Pos014"
 * DVSConfigSpec.DVSContactInfo.contact is set to
 * "Contact CreateDVS-Pos014 Description"
 */
public class Pos014 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create a DVSwitch inside a valid folder with"
               ...
               + "'CreateDVS-Pos014',\n"
               + "3.DVSConfigSpec.DVSContactInfo.contact is set"
               + " to 'Contact CreateDVS-Pos014 Description'.");
   }
