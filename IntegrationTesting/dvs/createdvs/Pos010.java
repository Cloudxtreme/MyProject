 ...
 * DVSConfigSpec.name is set to "Create DVS- Pos010" DVSConfigSpec.maxPorts is
 * set to 1016 DVSConfigSpec.numPorts is set to 1016
 */
public class Pos010 extends CreateDVSTestBase
{
   /**
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create a DVSwitch inside a valid folder with"
               ...
               + "'Create DVS- Pos010',\n"
               + "3.DVSConfigSpec.maxPorts is set to 1016,\n"
               + "4.DVSConfigSpec.numPorts is set to 1016.");
   }
      ...
      log.info("Test setup Begin:");
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               this.configSpec.setMaxPorts(1016);
               this.configSpec.setNumStandalonePorts(1016);
               status = true;
            } else {
