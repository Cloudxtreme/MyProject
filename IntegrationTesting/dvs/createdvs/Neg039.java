 ...
 * DVSConfigSpec.name is set to "CreateDVS-Neg039" - DVPortSetting.blocked is
 * set to false - outShapingPolicy.enabled is set to true -
 * outShapingPolicy.peakBandWidth is set to -1.
 */
public class Neg039 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create a DVS inside a valid folder with the"
               ...
               + "  - DVSConfigSpec.name is set to 'CreateDVS-Neg039'\n"
