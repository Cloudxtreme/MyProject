 ...
 * set to false - uplinkPortOrder.standbyUplinkPort is set to an invalid array
...
public class Neg047 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create a DVS inside a valid folder with the"
               ...
               + "  - DVSConfigSpec.name is set to 'CreateDVS-Neg047'\n"
      ...
      log.info("Test setup Begin:");
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               portOrderPolicy.getStandbyUplinkPort().addAll(com.vmware.vcqa.util.TestUtil.arrayToVector(new String[] {
                        "invalidUplink1", "@#$%^&*", "543543545345fdg", "34535gDFGgdgdg" }));
