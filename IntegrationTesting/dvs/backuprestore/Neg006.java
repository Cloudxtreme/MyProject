...
public class Neg006 extends TestBase
{
   ...
   {
      super.setTestDescription("Call import with new identifier after only changing the vds config names\n"
               + " 1. Create 2 DVS (DVS1 and DVS2)\n"
    ...
    */
   @Override
   @Test(description = "Call import with new identifier after only chaning the vds config names\n"
               + " 1. Create 2 DVS (DVS1 and DVS2)\n"
               + " 2. create ephemeral portgroups DVPG1 on DVS1 and DVPG2 on DVS2\n"
               + " 3. create a VM with 2 vNics\n"
               + " 4. Define DVPG1 as the backing for vNic1 and DVPG2 as the backing for vNic2\n"
      ...
      try {
         ...
         try {
            ...
            if (freePnics != null && freePnics.length >= 2) {
               ...
               vDSConfig[2].setName("importDVS2");
               deleteDVSConfiguration(dvsMorList);
               dvsMorList.clear();
            } else {
         ...
         iDVSMgr.importEntity(dvsManagerMor, vDSConfig, "createEntityWithNewIdentifier");
