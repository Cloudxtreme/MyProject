...
/**
 * Move n DVPorts where some are from an early binding and some are from late
 * binding DVPortGroup to a early bind DVPortGroup. Move DVPorts in (early &
 * late -> early) bind DVPortgroup.
 */
public class Pos018 extends MovePortBase
{
    ...
    * in early and late binding DVPortgroups as ports to move. 5. Create early
         ...
         if (super.testSetUp()) {
            ...
            if ((portgroupKeys != null) && !portgroupKeys.isEmpty()) {
               ...
               if ((portgroupKeys != null) && (portKeys.size() >= numPorts)) {
                  ...
                  log.error("Failed to create required number of "
