...
/**
 * Move a standalone DVPort connected to a powered on VM to late binding
 * DVPortGroup with livePortMovingAllowed flag set to false.
 */
public class Neg021 extends MovePortBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Move a standalone DVPort connected to a "
               + "powered on VM to late binding DVPortGroup with "
    ...
    * late binding DVPortgroup with livePortMovingAllowed=true. 5. Use the
    * standalone DVPort as the port to be moved. 6. Use the key of the late
