 ...
 * DVPortGroup to another late binding DVPortGroup. Move DVPorts (standalone &
 * late) -> late bind port group.
 */
public class Pos023 extends MovePortBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Move n DVPorts where some standalone and some are "
               + "from late binding DVPortGroup to another "
    ...
    * added DVPortgroup as ports to move. 5. Create another late binding
    * DVPortGroup and use its key as destination.
    * 
            ...
            if (portKeys.size() >= numPorts) {
               ...
               if ((portgroupKeys != null) && !portgroupKeys.isEmpty()) {
                  ...
                  if ((portgroupKeys != null) && !portgroupKeys.isEmpty()) {
                     ...
                     log.error("Failed to add another late binding DVPortgroup.");
                  }
               } else {
