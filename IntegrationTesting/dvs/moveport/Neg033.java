 ...
 * with livePortMovingAllowed = false, to an early binding DVPortgroup with
 ...
 * VM.</br> 5. Create early binding DVPortGroup with livePortMovingAllowed=true
 * and use it as destination.</br> Test:</br> 6. Move the DVPort to
 * destination.</br> Cleanup:</br> 7. Delete the DVS and logout.</br>
 */
public class Neg033 extends MovePortBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Move a DVPort connected to a powered on VM from "
               ...
               + "livePortMovingAllowed = false, to an early binding "
                  ...
                  if ((portKeys != null) && (portKeys.size() >= 1)) {
                     ...
                     if ((vm1DeltaCfgSpec != null)
                        ...
                        if ((portgroupKeys != null)
                           ...
                           log.error("Failed to add early bind port group.");
                        }
                     } else {
