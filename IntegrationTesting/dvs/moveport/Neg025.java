 ...
 * VM.</br> 5. Create early binding DVPortGroup with livePortMovingAllowed=false
 ...
 */
public class Neg025 extends MovePortBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Move a DVPort connected to a powered on VM from "
               ...
               + "DVPortgroup with livePortMovingAllowed = false.");
   }
