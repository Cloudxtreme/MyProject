 ...
 * DVPortgroup.
 */
public class Pos007 extends MovePortBase
{
   ...
   {
      setTestDescription("Move a standalone DVPort bound to a powered on VM to "
               + "a late binding DVPortGroup.");
   }
    ...
    */
   @Override
   @Test(description = "Move a standalone DVPort bound to a powered on VM to "
               + "a late binding DVPortGroup.")
   public void test()
      throws Exception
   {
