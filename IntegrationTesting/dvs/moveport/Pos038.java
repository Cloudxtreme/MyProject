 ...
 * to an early binding DVPortgroup with livePortMovingAllowed = false. </br>
 * Procedure:</br> Setup:</br> 1. Create a DVS.</br> 2. Get A VM, used for
 * connecting the DVPort to be moved.</br> 3. Create early binding DVPortgroup
 * and connect the VM to a DVPort in it and use it as port to be moved.</br> 4.
 * Verify power ops the VM.</br> 5. Create early binding DVPortGroup with
 ...
 * logout.</br>
 */
public class Pos038 extends MovePortBase
{
