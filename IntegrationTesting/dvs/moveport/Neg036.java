...
/**
 * Move a DVPort which has Settings with valid inShapingPolicy to a early
 * binding DVPortgroup with settingShapingOverrideAllowed=false.
 */
public class Neg036 extends MovePortBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Move a DVPort which has Settings with valid "
               + "outShapingPolicy to a early binding DVPortGroup with "
    ...
    * reconfigure it to set valid outShapingPolicy and use it as the port to be
    * moved.
    * 
         ...
         if (super.testSetUp()) {
            ...
            if (portgroupKeys != null) {
               ...
               if (portKeys != null) {
                  ...
                  this.shapingPolicy = DVSUtil.getTrafficShapingPolicy(false,
