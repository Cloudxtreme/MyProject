 ...
 * the VM to a late binding DVPortgroup .</br> 4. Power on the VM.</br> 5.
 * Create late binding DVPortGroup with livePortMovingAllowed = false and use it
 * as destination.</br> Test:</br> 6. Move the DVPort to destination, Should
 * fail.</br> Cleanup:</br> 7. Delete the DVS and logout.</br>
 */
public class Neg060 extends MovePortBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Move a DVPort connected to a powered on VM from "
               ...
               + "1. Create a DVS\n"
               + "2. Get A VM, used for connecting the DVPort to be moved.\n"
               + "3. Create late binding DVPortgroup with livePortMovingAllowed = true \n"
               + "  and connect the VM to a late binding DVPortgroup .\n"
               + "4. Power on the VM.\n"
               + "5. Create late binding DVPortGroup with livePortMovingAllowed = false \n"
               + " and use it as destination\n"
               + "6. Move the DVPort to destination, Should fail\n");
   }
