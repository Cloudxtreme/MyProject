 ...
 * 3. Create late binding DVPortgroup with livePortMovingAllowed = false and
...
public class Pos059 extends MovePortBase
{
      ...
      throws Exception
   {
      ...
      aPortGroupCfg = buildDVPortgroupCfg(DVPORTGROUP_TYPE_LATE_BINDING, 1,
               policy, null);
      portgroupKeys = addPortgroups(dvsMor, aPortGroupCfg);
      assertTrue((portgroupKeys != null && portgroupKeys.size() >= 1),
               "Successfully added early binding " + "DVPortgroup.",
               "Failed to add late bind port group.");
