 ...
 * dest_defaultPortConfig blocked = false , src_defaultPortConfig blocked= true.
...
public class Pos010 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Create two dvswitches with the following "
               + "configuration: dest_defaultPortConfig.blocked = false, "
               + "src_defaultPortConfig.blocked=true. Merge the two dvswitches.");
   }
      ...
      throws Exception
   {
      ...
      log.info("Test setup Begin:");
         ...
         if (this.rootFolder != null) {
            ...
            dest.setBlocked(DVSUtil.getBoolPolicy(false, false));
            ...
            src.setBlocked(DVSUtil.getBoolPolicy(false, true));
