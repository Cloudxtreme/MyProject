 ...
 * DVS has a pvlan map with a promiscuous map entry of 10, and an isolated map
 * entry of 20. b. The source DVS has a pvlan map entry with a promiscuous map
 * entry of 10, and an isolated map entry of 30. An early binding portgroup on
 * this DVS is configured to use this pvlan id in the default port config.
 */
public class Neg014 extends TestBase
{
   ...
   {
      setTestDescription("Merge two dv switches with the following properties"
               + " set. a. The destination DVS has a  pvlan map with"
               + " a promiscuous map entry of 10, and an isolated "
               + "map entry of 20. b. The source DVS has a pvlan map"
               + " entry with a promiscuous map entry of 10, and "
               + "an isolated map entry of 30. An early binding"
               + " portgroup on this DVS is configured to use this"
         ...
         if (this.dcMor != null) {
            ...
            if (srcDvsMor != null) {
               ...
               if (this.iDVSwitch.addSecondaryPvlan(this.srcDvsMor,
                        DVSTestConstants.PVLAN_TYPE_ISOLATED, 10, 30, true)) {
                  ...
                  if (this.iDVSwitch.addPortGroups(this.srcDvsMor,
                     ...
                     if (this.destDvsMor != null) {
                        ...
                        if (this.iDVSwitch.addSecondaryPvlan(this.destDvsMor,
                                 DVSTestConstants.PVLAN_TYPE_ISOLATED, 10, 20,
                                 true)) {
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Merge two dv switches with the following properties"
               + " set. a. The destination DVS has a  pvlan map with"
               + " a promiscuous map entry of 10, and an isolated "
               + "map entry of 20. b. The source DVS has a pvlan map"
               + " entry with a promiscuous map entry of 10, and "
