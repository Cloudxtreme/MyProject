...
/**
 * Merge a source DVS inside a valid folder with a destination DVS which has a
 * null MOR
 */
public class Neg001 extends TestBase
{
   ...
   {
      setTestDescription("Merge a source DVS inside a valid folder with a "
               + "destination DVS which has a null DVS MOR");
   }
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Merge a source DVS inside a valid folder with a "
               + "destination DVS which has a null DVS MOR")
   public void test()
      throws Exception
   {
