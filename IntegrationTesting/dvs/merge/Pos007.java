...
/**
 * Create two dvswitches with the following configuration: dest_contact = Valid
 * , src_contact = Valid Merge the two dvswitches.
 */
public class Pos007 extends TestBase
{
   ...
   private DVSContactInfo contactInfo = null;
   ...
   public void setTestDescription()
   {
      setTestDescription("Create two dvswitches with the following "
               + "configuration: dest_capability = dest_contact = Valid "
               + "src_contact = Valid. Merge the two dvswitches.");
   }
      ...
      throws Exception
   {
      ...
      log.info("Test setup Begin:");
         ...
         if (this.rootFolder != null) {
            ...
            this.contactInfo = new DVSContactInfo();
            this.contactInfo.setContact(DVSTestConstants.DVSCONTACTINFO_CONTACT
                     + DVSTestConstants.DVS_DESTINATION_SUFFIX);
            this.contactInfo.setContact(DVSTestConstants.DVSCONTACTINFO_NAME
                     + this.getTestId()
                     + DVSTestConstants.DVS_DESTINATION_SUFFIX);
            this.configSpec.setContact(this.contactInfo);
               ...
               if (this.iDVSwitch.isExists(this.destDvsMor)) {
                  ...
                  if (mergedDVSConfigInfo != null) {
                     ...
                     for (Iterator<String> iterator = props.iterator(); iterator.hasNext();) {
                        ...
                        if (DVSTestConstants.CONTACT.equals(prop)) {
                           iterator.remove();
                           break;
                        }
                     }
