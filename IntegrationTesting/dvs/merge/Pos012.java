 ...
 * dest_defaultPortConfig valid outShaping policy , src_defaultPortConfig valid
 * outShaping policy Merge the two dvswitches.
 */
public class Pos012 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Create two dvswitches with the following "
               + "configuration: dest_defaultPortConfig valid outShapingPolicy, "
               + "src_defaultPortConfig valid outShapingPolicy. "
      ...
      throws Exception
   {
      ...
      log.info("Test setup Begin:");
         ...
         if (this.rootFolder != null) {
            ...
            this.dest.setOutShapingPolicy(outShapingPolicy);
            ...
            this.src.setOutShapingPolicy(outShapingPolicy);
