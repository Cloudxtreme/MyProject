 ...
 * is set to true  and switchProductSpec as valid ProductSpec for the<BR>
 ...
 * CLEANUP<BR>
 */
public class Pos021 extends TestBase implements IDataDrivenTest 
{
   /*
   ...
   public void setTestDescription()
   {
      setTestDescription("1. Get the compatible hosts for given vDs version\n"
               ...
               + "   a) The host array consists of the second host "
               + "and the inclusive flag is set   to true and"
               + " switchProductSpec as valid ProductSpec for the "
               + "    new version of vds"
               + "   b) The host array consists of the first host"
               + " and the inclusive"
      ...
      throws Exception
   {
      ...
      hostArrayFilter1 = DVSUtil.createHostArrayFilter(hosts, true);
      hosts.clear();
