...
/**
 * Clone a VM from a powered on VM(VM1) that is connected to an early binding
 ...
 * connectivity.
 */
public class Pos028 extends FunctionalTestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Clone a VM from a powered on VM(VM1) that is"
               + " connected to an early binding port group, that has"
