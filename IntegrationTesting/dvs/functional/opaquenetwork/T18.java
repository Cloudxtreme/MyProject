...
/**
 * Move the vm from one dvport to an opaque network
 *
 * @author sabesanp
 *
 */

public class T18 extends TestBase
{
      ...
      throws Exception
   {
      ...
      /*
       * Reconfigure the virtual machine to connect to a dvport
       */
      DistributedVirtualSwitchPortConnection[] portConnection = new
               DistributedVirtualSwitchPortConnection[1];
      for(int i=0;i<1;i++){
      ...
      System.out.println("\n ######## vds uuid = " + dvs.getConfig(srcVdsMor).
               getUuid());
