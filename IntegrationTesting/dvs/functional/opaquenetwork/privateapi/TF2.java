...
public class TF2 extends PrivateApiBase
{
      ...
      throws Exception
   {
      ...
      assertTrue(
        GetOpaqueSwitches().get(0).getPnicZone().size() == 2,
        "2 pnic zones successfully created as part of opaque switch",
      ...
      assertTrue(
        ...
        "pnic zone 2 created as part of opaque switch", "pnic zone creation error "
        + GetOpaqueSwitches().get(0).getPnicZone().get(1));

      HostOpaqueSwitch hostOpaqueSwitch =  GetOpaqueSwitches().get(0);
      hostOpaqueSwitch.setPnicZone(
            GetOpaqueSwitches().get(0).getPnicZone().subList(0, 1));
