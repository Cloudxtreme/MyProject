...
public class T10 extends TestBase{
        ...
        public boolean testSetUp() throws Exception {
                ...
                String id = opaqueNetworkInfo.get(0).getOpaqueNetworkId();
                String type = opaqueNetworkInfo.get(0).getOpaqueNetworkType();
                String name = opaqueNetworkInfo.get(0).getOpaqueNetworkName();
                ...
                opaqueNetworkBackingInfo.setOpaqueNetworkId(id);
                opaqueNetworkBackingInfo.setOpaqueNetworkType(type);
                /*VirtualEthernetCardOpaqueNetworkBackingInfo opaqueNetworkBackingInfo
        ...
        public void test() throws Exception {
                ...
                Map<String,String> ethMap = NetworkUtil.
                                getEthernetCardNetworkMap(vmMor, connectAnchor);
                for(String dev : ethMap.values()){
                        assertTrue(dev.equals(opaqueNetworkInfo.get(0).
