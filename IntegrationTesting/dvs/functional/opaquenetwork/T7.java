...
public class T7 extends TestBase{
        ...
        public boolean testSetUp() throws Exception {
                ...
                /*
                 * Get the hosts in the vc inventory
                 */
                hostMorList = hostSystem.getAllHost();
                assertTrue(hostMorList != null && hostMorList.size() >= 2,
                                  "Found atleast two hosts in the inventory",
                                  "Failed to find two hosts in the inventory");
                /*
                 * Query for the opaque network
                 */
                nsMor = ins.getNetworkSystem(hostMorList.get(0));
                ...
                /*
                 * Get two vms on host 1 and host 2
                 */
        srcVmMor = hostSystem.getVMs(hostMorList.get(0),
                           VirtualMachinePowerState.POWERED_OFF).get(0);
        destVmMor = hostSystem.getVMs(hostMorList.get(1),
                           VirtualMachinePowerState.POWERED_OFF).get(1);

        assertTrue(srcVmMor != null, "src vm mor is not null", "src vm mor is null");
        assertTrue(destVmMor != null, "dest vm mor is not null", "dest vm mor is null");
         ...
         */
                ...
                nsMor = ins.getNetworkSystem(hostMorList.get(1));
