 ...
 * connected to a standalone port on the DVS and the port is occupied, while
 * reverting the snapshot.
 */
public class Pos008 extends VMSFunctionalTestBase
{
   /**
   ...
   public void setTestDescription()
   {
      setTestDescription("Revert a powered off VM to a snapshot when it's VM"
               ...
               + " on the DVS and the port is occupied, while "
               + "reverting the snapshot.");
   }
