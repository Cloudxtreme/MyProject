 ...
 * to a port in an early binding portgroup of the DVSwitch to a different
 * datastore on a host that has multiple datastores. The VM moves to the
 * destination datastore.
 */
public class Pos003 extends SVMFunctionalTestBase
{

   public void setTestDescription()
   {
      setTestDescription("Storage vmotion a powered on VM via a vmotion virtual"
               + " nic that is connected to a port in an earlybinding "
               + "dvport of the DVSwitch to a different datastore on "
               + "a host that has multiple datastores. The VM moves "
