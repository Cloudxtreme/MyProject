...
/**
 * Clone a VM from a powered off VM(VM1) that is connected to an early binding
 ...
 * connectivity.
 */
public class Pos024 extends FunctionalTestBase
{
      ...
      throws Exception
   {
      ...
      String ipAddress = null;
         ...
         relocateSpec.setDatastore(this.ivm.getDatastoresInfo(this.vmMor).get(
                  0).getDatastoreMor());
