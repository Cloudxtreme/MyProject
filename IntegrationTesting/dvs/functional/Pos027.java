...
/**
 * Clone a VM from a powered on VM that is connected to the standalone DV Port
 * of the DVSwitch. The VM can be powered on and the VM will not have network
 * connectivity.
 */
public class Pos027 extends FunctionalTestBase
{
   ...
   {
      setTestDescription("Clone a VM from a powered on VM that is connected"
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Clone a VM from a powered on VM that is connected"
               + " to the standalone DV Port of the DVSwitch. The "
               + "VM can be powered on and the VM will not have "
               + "network connectivity.")
   public void test()
