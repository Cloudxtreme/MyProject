 ...
 * to an early binding portgroup.
 */
public class Neg006 extends FunctionalTestBase
{
      ...
      if (super.testSetUp()) {
            ...
            if (pgKey != null) {
               ...
               vmConfigSpec = DVSUtil.buildCreateVMCfg(connectAnchor,
                        dvsPortConnection, VM_VIRTUALDEVICE_ETHERNET_PCNET32,
                        this.vmName, hostMor);
   ...
   @Test(description = "Disconnect the host(H1) from the VC, Using hostd "
               + "Create a VM (VM1) to connect to an early binding "
               + "portgroup.")
   public void test()
      throws Exception
   {
      try {
         ...
         if (newAuthenticationMor != null) {
            ...
            if (newLoginSession != null) {
               ...
               log.error("Can not login into hostd");
            }
         } else {
