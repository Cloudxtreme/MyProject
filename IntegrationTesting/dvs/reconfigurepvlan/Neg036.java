...
/**
 * Remove a PVLAN map entry by providing "4095" as PVLAN ID.
 */
public class Neg036 extends PvlanBase
{
   /**
   ...
   {
      setTestDescription("Remove a PVLAN map entry by providing \"4095\" "
               + "as PVLAN ID.");
   }
    ...
    */
   @Override
   @Test(description = "Remove a PVLAN map entry by providing \"4095\" "
               + "as PVLAN ID.")
   public void test()
      throws Exception
   {
      ...
      try {
         iVmwareDVS.removePvlan(dvsMor, PVLAN_TYPE_PROMISCUOUS, 4045, 4045,
                  false);
