...
/**
 * Add a PVLAN map entry to DVS by providing valid MOR but invalid PVLAN type.
 */
public class Neg010 extends PvlanBase
{
   /**
      ...
      throws Exception
   {
      ...
      try {
         iVmwareDVS.addPvlan(dvsMor, "invalidType", PVLAN1_PRI_1, PVLAN1_PRI_1);
