 ...
 * 1 with port type as community.
 */
public class Neg024 extends PvlanBase
{
   /**
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a PVLAN map entry to the DVS with primary ID "
               + "as 4095 and secondary ID as 1 with port type as community.");
   }
      ...
      throws Exception
   {
      ...
      try {
         iVmwareDVS.addPvlan(dvsMor, PVLAN_TYPE_COMMINITY, MAX_PVLAN_ID + 1, 1);
