 ...
 */
public class Neg019 extends PvlanBase
{
   /**
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a PVLAN map entry to the DVS with primary ID "
               + "as 0 and secondary ID as 1 with port type as community.");
   }
      ...
      throws Exception
   {
      ...
      try {
         iVmwareDVS.addPvlan(dvsMor, PVLAN_TYPE_PROMISCUOUS, 0, MIN_PVLAN_ID);
