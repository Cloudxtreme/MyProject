...
/**
 * Add a PVLAN map entry to the DVS with PVLAN ID as 4094. Procedure:<br>
 * Setup: 1. Create a DVS.<br>
 * Test:<br>
 * 2. Add a primary PVLAN map entry to DVS with PVLAN ID as 4094.<br>
 * Cleanup:<br>
 * 3. Deleted the DVS.<br>
 * 4. Log off from VC.<br>
 */
public class Pos014 extends PvlanBase
{
   /**
   ...
   {
      setTestDescription("Add a PVLAN map entry to DVS with PVLAN ID as 4094.");
   }
    ...
    */
   @Override
   @Test(description = "Add a PVLAN map entry to DVS with PVLAN ID as 4094.")
   public void test()
      throws Exception
   {
      boolean status = false;
      log.info("Test Begin:");
         ...
         if (iVmwareDVS.addPrimaryPvlan(dvsMor, MAX_PVLAN_ID)) {
