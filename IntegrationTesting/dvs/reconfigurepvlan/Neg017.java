...
/**
 * Add a PVLAN map entry to the DVS with ID as 0 with port type as promiscuous.
 */
public class Neg017 extends PvlanBase
{
   /**
   ...
   {
      setTestDescription("Add a PVLAN map entry to the DVS with ID as 0 with "
               + "port type as promiscuous.");
   }
    ...
    */
   @Override
   @Test(description = "Add a PVLAN map entry to the DVS with ID as 0 with "
               + "port type as promiscuous.")
   public void test()
      throws Exception
   {
      ...
      try {
         iVmwareDVS.addPvlan(dvsMor, PVLAN_TYPE_PROMISCUOUS, 0, 0);
