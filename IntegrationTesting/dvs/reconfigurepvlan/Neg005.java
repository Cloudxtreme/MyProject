...
/**
 * Add a PVLAN map entry to DVS by providing valid MOR and but secondary VLAN ID
 * as '0'.
 */
public class Neg005 extends PvlanBase
{
   /**
      ...
      throws Exception
   {
      ...
      try {
         iVmwareDVS.addPvlan(dvsMor, PVLAN_TYPE_PROMISCUOUS, PVLAN1_PRI_1, 0);
