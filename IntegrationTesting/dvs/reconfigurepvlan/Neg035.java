...
/**
 * Remove a PVLAN map entry by providing "0" as PVLAN ID.
 */
public class Neg035 extends PvlanBase
{
   /**
   ...
   {
      setTestDescription("Remove a PVLAN map entry by providing 0 as PVLAN ID.");
   }
    ...
    */
   @Override
   @Test(description = "Remove a PVLAN map entry by providing 0 as PVLAN ID.")
   public void test()
      throws Exception
   {
      boolean status = false;
      ...
      try {
         iVmwareDVS.removePvlan(dvsMor, PVLAN_TYPE_PROMISCUOUS, 0, 0, false);
