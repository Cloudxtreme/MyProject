...
/**
 * Add a PVLAN map entry to DVS by providing invalid MOR and other parameters
 * intact.
 */
public class Neg003 extends PvlanBase
{
   /**
   ...
   {
      setTestDescription("Add a PVLAN map entry to DVS by providing invalid MOR"
    ...
    */
   @Override
   @Test(description = "Add a PVLAN map entry to DVS by providing invalid MOR"
               + " and other parameters intact.")
   public void test()
      throws Exception
   {
      ...
      try {
         iVmwareDVS.addPrimaryPvlan(iFolder.getRootFolder(), PVLAN1_PRI_1);
