 ...
 * late binding DVportgroup on an existing DVSwitch. The distributedVirtualPort
 * is of type DVSPortgroupConnection. A invalid DV port key on a late binding
 * DVportgroup A valid late binding DVportgroup.
 */
public class Neg004 extends VNicBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Update an existing  service console  vnic to"
               + " connect to an existing DVPort on an late binding DVportgroup "
