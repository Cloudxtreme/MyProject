 ...
 * switch with portConfigResetAtDisconnect set to false and
                  ...
                  if (this.iVirtualMachine.reconfigVM(vmMor,
                     ...
                     if (portConfigSpec != null && portConfigSpec[0] != null) {
                        log.info("Successfully obtained the port "
                                 + "config spec");
                        if (portConfigSpec[0].getSetting().getBlocked().isInherited() == false
                                 && portConfigSpec[0].getSetting().getBlocked().isValue() == (false)) {
                           status = true;
