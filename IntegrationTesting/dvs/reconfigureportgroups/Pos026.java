 ...
 * switch and reconfigure a VM to connect its VNIC to this portgroup with
...
public class Pos026 extends TestBase
{
   ...
   /**
    * Method that reconfigures an early binding portgroup and reconfigures a
      ...
      throws Exception
   {
      ...
      try {
         ...
         if (this.iDVPortgroup.reconfigure(this.dvPortgroupMorList.get(0),
