 ...
 * with an invalid number of ports which is greater than the max number of ports
 * in the dvswitch
 */
public class Neg010 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Reconfigure a portgroup on an existing "
               ...
               + "number of ports which is greater than the max "
    ...
    * switch with an invalid number of ports
    * 
    * @param connectAnchor ConnectAnchor object
    */
      ...
      throws Exception
   {
      ...
      try {
         ...
         if (dvPortgroupMorList != null && dvPortgroupMorList.size() > 0) {
            ...
            this.dvPortgroupConfigSpec.setNumPorts(11);
