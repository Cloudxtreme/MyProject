 ...
 * having DVPortgroup.PolicyOp privilege
 */
public class Sec005 extends TestBase
{
   /*
   ...
   private boolean addRole()
   {
      ...
      final String[] privileges = { DVSTestConstants.DVSWITCH_CREATE_PRIVILEGE,
               ...
               DVSTestConstants.DVPORTGROUP_POLICY_PRIVILEGE };
    ...
    * a user having DVPortgroup.PolicyOp privilege
    *
    * @param connectAnchor ConnectAnchor object
    */
