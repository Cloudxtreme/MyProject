...
/**
 * Reconfigure a portgroup to an existing distributed virtual switch with a min
 * value for the vlanid id set in the default port config.
 */
public class Pos057 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Reconfigure a portgroup to an existing distributed "
               + "virtual switch with a min value for the valid vlanid"
               + " set in the default port config.");
   }
