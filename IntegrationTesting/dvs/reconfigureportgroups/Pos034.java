 ...
 * allowPromiscuous set to false
 */
public class Pos034 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Reconfigure a portgroup to an existing"
               + "distributed virtual switch with allowPromiscuous "
               + "set to false");
   }
      ...
      throws Exception
   {
      ...
      try {
         ...
         secPolicy = dvPortSetting.getSecurityPolicy();
         secPolicy.setAllowPromiscuous(DVSUtil.getBoolPolicy(false,
                  Boolean.FALSE));
         dvPortSetting.setSecurityPolicy(secPolicy);
