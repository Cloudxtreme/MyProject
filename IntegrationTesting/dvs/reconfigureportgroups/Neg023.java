...
/**
 * Reconfigure a portgroup with an invalid pvlanid
 */
public class Neg023 extends TestBase
{
   ...
   {
      setTestDescription("Reconfigure a portgroup with an invalid pvlanid");
   }
   ...
   /**
    * Method that reconfigures a portgroup with an invalid pvlanid
    *
    * @param connectAnchor ConnectAnchor object
    */
   @Override
   @Test(description = "Reconfigure a portgroup with an invalid pvlanid")
   public void test()
      throws Exception
   {
      log.info("Test Begin:");
