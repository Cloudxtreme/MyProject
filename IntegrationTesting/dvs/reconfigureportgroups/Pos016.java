 ...
 * switch with scope set to datacenter mor
 */
public class Pos016 extends TestBase
{
      ...
      throws Exception
   {
      ...
      try {
         ...
         this.dvPortgroupConfigSpec.getScope().addAll(com.vmware.vcqa.util.TestUtil.arrayToVector(new ManagedObjectReference[] { this.dcMor }));
