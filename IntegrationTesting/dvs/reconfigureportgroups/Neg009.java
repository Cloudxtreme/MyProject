 ...
 * switch to contain lesser number of ports than the original number of ports in
 * the portgroup
 */
public class Neg009 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Reconfigure an early binding portgroup on an "
               + "existing distributed virtual switch with number of"
               + " ports less than the orignal number of ports in "
               + "the portgroup");
   }
                                 ...
                                 if (vmDeltaConfigSpec != null) {
                                    if (this.iVirtualMachine.reconfigVM(vmMor,
                                       ...
                                       log.info("Successfully "
                                                + "reconfigured the VM to connect to "
   ...
   /**
    * Method that reconfigures an early binding portgroup to number of ports
    * which is less than the original number of ports
    * 
    * @param connectAnchor ConnectAnchor object
    */
      ...
      throws Exception
   {
      ...
      try {
         ...
         if (this.iDVPortgroup.reconfigure(dvPortgroupMorList.get(0),
            ...
            log.error("Successfully reconfigured the portgroup but "
                     + "the API did not throw an exception");

         } else {
            log.error("Could not reconfigure the portgroup but the "
