...
/**
 * Add a service console vnic to connect to an existing DVPort on an
 * earlyBinding DVPortgroup on an existing DVSwitch. Build the DVPortConnection
 * with invalid earlyBinding DVPortgroupKey. The distributedVirtualPort is of
...
public class Neg003 extends VNicBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a service console vnic to connect to an existing "
               + "DVPort on an existing earlyBinding DVPortgroup on an existing "
               + "DVSwitch. DVPortConnection with invalid earlyBinding "
               + "DVPortgroupKey. The DVPort is of type DistributedVirtualSwitchPortConnection.");
   }
    ...
    * invalid earlyBinding DVPortgroupKey. 3. Create the HostVirtualNic Spec.
    *
            ...
            if (networkUpdated) {
               ...
               if (portgroupKey != null) {
                  ...
                  if ((alternateIPAddress != null) && (subnetMask != null)) {
                     ...
                     log.info("successfully get the hostVNicSpec");
                  }else {
