 ...
 * on an existing DVSwitch. Build the DVPortConnection with invalid earlyBinding
 * DVPortgroupKey. The distributedVirtualPort is of type
 * DistributedVirtualSwitchPortConnection.
 */
public class Neg002 extends VNicBase
{
            ...
            if (networkUpdated) {
               ...
               if (portgroupKey != null) {
                  ...
                  if ((alternateIPAddress != null) && (subnetMask != null)) {
                     ...
                     hostVNicSpec = buildVnicSpec(dvsPortConnection, null,null,
                              true);
                  }
                  status = true;
               } else {
