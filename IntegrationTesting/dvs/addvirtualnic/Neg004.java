 ...
 * Connection. Build DVPortConnection with invalid DVPort Key on a latebinding
 * portgroup and valid latebinding portgroupKey.
 */
public class Neg004 extends VNicBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a service console vnic to connect to an "
               ...
               + "Connection. Build DVPortConnection with invalid DVPort Key  "
               + "on a latebinding portgroup and valid latebinding portgroupKey.");
   }

   /**
    * Method to setup the environment for the test. 1. Create the DVSwitch. 2.
    * Get the lateBinding PortgroupKey. 3. Build the DVPortConnection. 4. Create
