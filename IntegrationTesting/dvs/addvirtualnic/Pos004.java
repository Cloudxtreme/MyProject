...
public class Pos004 extends VNicBase
{
      ...
      throws Exception
   {
      ...
      int numPorts = 0;
      VirtualMachineConfigSpec vmConfig = null;
                     ...
                     if ((hostNetworkConfig != null)
                        ...
                        if (status) {
                           ...
                           if ((allVMs != null) && (allVMs.size() > 0)) {
                              ...
                              vmConfig = DVSUtil.buildDefaultSpec(
                                       connectAnchor,
                                       hostMor,
                                       TestConstants.VM_VIRTUALDEVICE_ETHERNET_PCNET32,
                                       this.getTestId() + "-VM");
                              if (vmConfig != null) {
                                 this.vmMor = new Folder(
                                          super.getConnectAnchor()).createVM(
                                          this.ivm.getVMFolder(),
                                          vmConfig,
                                          this.ihs.getResourcePool(this.hostMor).get(
                                                   0), this.hostMor);
                                 if (this.vmMor != null) {
      ...
      throws Exception
   {
      ...
      log.info("test setup Begin:");
         ...
         // Get the lateBinding portgroup and build portconnection.
         portgroupKey = iDVSwitch.addPortGroup(dvsMor,
                  DVPORTGROUP_TYPE_LATE_BINDING, 2, getTestId() + "-PG.");
      ...
      assertTrue(migrated, "Test Failed");
   }
            ...
            if ((this.vmMor != null)
               ...
               if (this.isVMCreated) {
                  ...
                  status &= this.ivm.destroy(this.vmMor);
                        ...
                        && ivm.reconfigVM(vmMor, originalVMConfigspec)) {
