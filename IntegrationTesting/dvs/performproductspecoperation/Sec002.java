...
/**
 * DESCRIPTION:<br>
 * Upgrade DVS from older vDs version to new vDs version by an user not having
 * DVSwitch.Modify privilege<br>
 * SETUP:<br>
 * 1. Create a DVSwitch with older vDs version .<br>
 * 2. Create new vDs version product spec<BR>
 * 3. Do not set 'DVSwitch.Modify' privilege on DVS.<br>
 ...
 */
public class Sec002 extends TestBase   implements IDataDrivenTest
{
   /*
   ...
   private String privilege = DVSWITCH_MODIFY;
   ...
   public void setTestDescription()
   {
      setTestDescription(""
               ...
               + " by an user not having DVSwitch.Modify privilege\n"
               + " 1.Create DVS with older vDs version \n"
               + " 2.Create new vDs version product "
               + "spec from  that event.\n"
      ...
      throws Exception
   {
      ...
      authHelper.setPermissions(dvsMor, DVSWITCH_CREATE, testUser, false);
      ...
      throws Exception
   {
      try {
         ...
         com.vmware.vcqa.util.Assert.assertTrue(
                  com.vmware.vcqa.util.TestUtil.checkMethodFaultLooseWay(
