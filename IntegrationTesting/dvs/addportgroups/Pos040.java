...
public class Pos040 extends TestBase
{
      ...
      throws Exception
   {
      ...
      Vector allVMs = null;
      VMwareDVSPortSetting vmwareDVSPortSetting = null;
                     ...
                     if (this.iVirtualMachine.setVMState(vmMor, VirtualMachinePowerState.POWERED_OFF, false)) {
                        ...
                        if (portKey != null) {
                           ...
                           if (this.iDVSwitch.getConfig(this.dvsMor).getDefaultPortConfig() instanceof VMwareDVSPortSetting) {
                              vmwareDVSPortSetting = DVSUtil.getDefaultVMwareDVSPortSetting(settingsMap);
                              portConfigSpec.setSetting(vmwareDVSPortSetting);
                           } else {
                           ...
                           if (this.iDVSwitch.reconfigurePort(dvsMor,
                              ...
                              settingsMap.put(DVSTestConstants.BLOCKED_KEY,
                                       true);
                              if (this.iDVSwitch.getConfig(this.dvsMor).getDefaultPortConfig() instanceof VMwareDVSPortSetting) {
                                 vmwareDVSPortSetting = DVSUtil.getDefaultVMwareDVSPortSetting(settingsMap);
                                 this.dvPortgroupConfigSpec.setDefaultPortConfig(vmwareDVSPortSetting);
                              } else {
                                 portSetting = DVSUtil.getDefaultPortSetting(
                                          settingsMap, null);
               ...
               if (this.iDVSwitch.movePort(dvsMor, new String[] { portKey },
                  ...
                  if (this.iVirtualMachine.reconfigVM(vmMor,
                     ...
                     if (this.iVirtualMachine.setVMState(vmMor, VirtualMachinePowerState.POWERED_ON, false)) {
                        ...
                        ipAddress = this.iVirtualMachine.getIPAddress(this.vmMor);
                        if (ipAddress != null) {
                           status = DVSUtil.checkNetworkConnectivity(
                                    this.iHostSystem.getIPAddress(hostMor),
                                    ipAddress);
                        } else {
                           log.error("Can not get an valid ip for the VM ");
                        }
                     } else {
