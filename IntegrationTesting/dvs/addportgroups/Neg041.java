 ...
 * DVPortgroupConfigSpec.DefaultPortConfig.vlan set to an out of range trunk
 * vlan spec
 */
public class Neg041 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a portgroup to an existing distributed virtual "
               + "switch with the vlan set to"
               + "borders out of vlan trunk range");
   }
