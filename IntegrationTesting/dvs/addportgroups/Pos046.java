...
public class Pos046 extends TestBase
{
      ...
      throws Exception
   {
      ...
      VmwareUplinkPortTeamingPolicy dvsUplinkTeamingPolicy = null;
      ...
      if (dcMor != null) {
         ...
         if (dvsMor != null) {
            ...
            dvsUplinkTeamingPolicy = DVSUtil.getUplinkPortTeamingPolicy(false,
                     null, null, false, null, null, null);
            settingsMap = new HashMap<String, Object>();
            settingsMap.put(DVSTestConstants.UPLINK_TEAMING_POLICY_KEY,
                     dvsUplinkTeamingPolicy);
                     ...
                     if (dvsPort != null) {
                        ...
                        if (dvsPort.get(0).getConfig().getSetting() instanceof VMwareDVSPortSetting) {
                           ...
                           status = TestUtil.compareObject(
                                    ...
                                    dvsPortSetting.getUplinkTeamingPolicy(),
                                    TestUtil.getIgnorePropertyList(
                                             dvsPortSetting, false));
                        }
                     } else {
