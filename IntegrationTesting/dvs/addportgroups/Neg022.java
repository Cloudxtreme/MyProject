...
/**
 * Add a portgroup with a pvlanid which is not defined in the DVS pvlan map
 * entry
 */
public class Neg022 extends TestBase
{
   ...
   {
      setTestDescription("Add a portgroup with a pvlanid which is not "
               + "defined in the DVS pvlan map entry");
   }
   ...
   /**
    * Method that adds a portgroup with a pvlanid which is not defined in the
    * DVS pvlan map entry
    *
    * @param connectAnchor ConnectAnchor object
    */
   @Override
   @Test(description = "Add a portgroup with a pvlanid which is not "
            + "defined in the DVS pvlan map entry")
   public void test()
      throws Exception
   {
