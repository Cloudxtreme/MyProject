...
/**
 * Add a portgroup with an invalid outshaping policy
 */
public class Neg020 extends TestBase
{
   ...
   {
      setTestDescription("Add a portgroup with an invalid outshaping policy");
   }
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Add a portgroup with an invalid outshaping policy")
   public void test()
      throws Exception
   {
      log.info("Test Begin:");
