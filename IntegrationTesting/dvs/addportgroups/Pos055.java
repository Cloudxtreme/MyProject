 ...
 * an isolated pvlan id in the default port config and pg2 having the isolated
...
public class Pos055 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Add two early binding portgroups pg1, and pg2 to "
               + "the DVSwitch with pg1 having an isolated pvlan "
               + "id in the default port config and pg2 having the"
