...
/**
 * Add a portgroup with an invalid "numPorts"
 */
public class Neg006 extends TestBase
{
   ...
   {
      setTestDescription("Add a portgroup with an invalid numPorts");
   }
      ...
      log.info("Test setup Begin:");
         ...
         if (this.dcMor != null) {
            ...
            if (dvsMor != null) {
               ...
               this.dvPortgroupConfigSpec.setNumPorts(-15);
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Add a portgroup with an invalid numPorts")
   public void test()
      throws Exception
   {
      log.info("Test Begin:");
