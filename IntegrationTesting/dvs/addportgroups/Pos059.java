...
/**
 * Add an early binding portgroup to the DVSwitch with an isolated pvlan id in
...
public class Pos059 extends TestBase
{
   ...
   {
      setTestDescription("Add an early binding portgroup to the DVSwitch with"
               + " an isolated pvlan id in the default port config.");
   }
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Add an early binding portgroup to the DVSwitch with"
               + " an isolated pvlan id in the default port config.")
   public void test()
      throws Exception
   {
      ...
      String switchUUID = null;
         ...
         if (this.dvPortgroupMorList != null
            ...
            if (portkeys != null && portkeys.size() == 2) {
               ...
               portConnection.setPortgroupKey(portgroupKey);
               portConnection.setPortKey(portkeys.get(1));
