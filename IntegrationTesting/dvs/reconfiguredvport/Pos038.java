 ...
 */
public class Pos038 extends CreateDVSTestBase
{
   ...
   private final int DVS_PORT_NUM = 2;
   ...
   {
      super.setTestDescription("Reconfigure DVPort name with a duplicate name");
   }
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Reconfigure DVPort name with a duplicate name")
   public void test()
      throws Exception
   {
      log.info("Test Begin:");
