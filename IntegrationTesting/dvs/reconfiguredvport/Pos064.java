 ...
 * set to true/false in VMPortConfigPolicy and Inherited set to true/false<br>
 * SETUP:<br>
 * 1. Create a DVS by adding a host to VC.<br>
 * 2. Create portConfigSpecs object with IpfixEnabled and IpfixInherited parameter set <br>
 * TEST:<br>
 ...
 *
 */
public class Pos064 extends TestBase implements IDataDrivenTest
{
   ...
   private boolean isIpfixEnabled = false;
      ...
      throws Exception
   {
      ...
      // Set IpfixEnabled to true/false and Inherited to true/false
      isInherited = data.getBoolean(DVSTestConstants.IP_FIX_INHERITED_KEY,
               false);
      isIpfixEnabled = data.getBoolean(DVSTestConstants.IP_FIX_ENABLED_KEY,
               true);
      dvPort.setIpfixEnabled(DVSUtil.getBoolPolicy(isInherited, isIpfixEnabled));
