...
public class Pos012 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure DVPort and set a valid "
               + "ResourcePool Mor in scope property");
   }
               ...
               if (this.dvsMOR != null) {
                  ...
                  if (portKeyList != null && portKeyList.size() == DVS_PORT_NUM) {
                     ...
                     if (ihs.getAllHost() != null) {
                        ...
                        portConfigSpecs[0].getScope().addAll(com.vmware.vcqa.util.TestUtil.arrayToVector(new ManagedObjectReference[] { icr.getResourcePool(ihs.getParentNode(ihs.getAllHost().get(
                                 0))) }));
