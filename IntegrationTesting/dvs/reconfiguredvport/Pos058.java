...
public class Pos058 extends CreateDVSTestBase
{
   ...
   {
      setTestDescription("Reconfigure an existing DV port.Set the "
               + "teaming policy as LBT(Dynamic Load Balancer in NIC Teaming).");
   }
    ...
    * @throws Exception
    */
   @Test(description = "Reconfigure an existing DV port.Set the "
               + "teaming policy as LBT(Dynamic Load Balancer in NIC Teaming).")
   public void test()
      throws Exception
   {
      assertTrue(
               ...
               "Reconfigured the dvport to set the teaming policy as LBT",
               "Failed "
                        + "to reconfigure the dvport to set the teaming policy as LBT");
   }
      ...
      try {
         ...
         if (dvPorts != null && dvPorts.get(0) != null) {
            ...
            if (dvPortConfigInfo != null) {
               ...
               setting.setUplinkTeamingPolicy(uplinkTeamingPolicy);
