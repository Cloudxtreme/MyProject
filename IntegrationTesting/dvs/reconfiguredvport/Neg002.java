...
public class Neg002 extends CreateDVSTestBase
{
   ...
   {
      super.setTestDescription("Reconfigure DVPort and set the length of name "
               + "beyond the database limit");
   }
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  if (portKeyList != null && portKeyList.size() == DVS_PORT_NUM) {
                     ...
                     portConfigSpecs[0].setName(cstrInvalidName());
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Reconfigure DVPort and set the length of name "
               + "beyond the database limit")
   public void test()
      throws Exception
   {
