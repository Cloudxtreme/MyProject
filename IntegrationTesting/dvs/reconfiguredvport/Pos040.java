 ...
 */
public class Pos040 extends CreateDVSTestBase
{
   ...
   {
      super.setTestDescription("Reconfigure DVPort  with  whitespace name");
   }
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Reconfigure DVPort  with  whitespace name")
   public void test()
      throws Exception
   {
      log.info("Test Begin:");
