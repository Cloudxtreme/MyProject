 ...
 */
public class Pos037 extends CreateDVSTestBase
{
   ...
   {
      super.setTestDescription("Reconfigure DVPort name with space");
   }
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  if (portKeyList != null && portKeyList.size() == DVS_PORT_NUM) {
                     ...
                     portConfigSpecs[0].setName(this.getTestId() + " PG");
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Reconfigure DVPort name with space")
   public void test()
      throws Exception
   {
      log.info("Test Begin:");
