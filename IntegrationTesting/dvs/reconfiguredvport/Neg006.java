...
public class Neg006 extends CreateDVSTestBase
{
   ...
   {
      super.setTestDescription("Set averageBandWidth of inShapingPolicy to "
               + "negative value");
   }
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Set averageBandWidth of inShapingPolicy to "
               + "negative value")
   public void test()
      throws Exception
   {
   ...
   private DVPortConfigSpec createPortConfigSpec(String key)
   {
      ...
      DVSTrafficShapingPolicy inShapingPolicy = DVSUtil.getTrafficShapingPolicy(
               false, true, new Long(-1), null, null);
      setting.setInShapingPolicy(inShapingPolicy);
