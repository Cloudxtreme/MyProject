...
public class Neg017 extends CreateDVSTestBase
{
   ...
   private final String INVALID_POLICY_STR = "invalid";
   ...
   {
      super.setTestDescription("Reconfigure DVPort with invalid policy for "
               + "uplinkTeamingPolicy");
   }
    ...
    */
   @Override
   @Test(description = "Reconfigure DVPort with invalid policy for "
            + "uplinkTeamingPolicy")
   public void test()
      throws Exception
   {
            ...
            if (dvPortConfigInfo != null) {
               ...
               if (uplinkTeamingPolicy == null) {
                  uplinkTeamingPolicy = DVSUtil.getUplinkPortTeamingPolicy(
                           false, INVALID_POLICY_STR, null, null, null, null,
                           null);
               } else {
