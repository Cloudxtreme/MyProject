...
/**
 * DESCRIPTION:Associate/Disassociate a newly created nrp with a dvPort<BR>
 * TARGET: VC <BR>
 * SETUP:<BR>
 * 1. Create a vDS<BR>
 * 2. Enable netiorm <BR>
...
public class Pos060 extends TestBase
{
    ...
    * Test method
    */
   @Test(description = "Associate/Disassociate a newly created nrp with a dvPort")
   public void test()
      throws Exception
   {
   ...
   {
      setTestDescription("Associate/Disassociate a newly created nrp with a dvPort");
   }
