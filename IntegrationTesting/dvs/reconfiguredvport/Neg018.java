...
public class Neg018 extends CreateDVSTestBase
{
   ...
   private final String INVALID_PORTNAME_STR = "invalid";
   ...
   /**
    * create DVPort ConfigSpec and set invalid uplink port name in active port
    * list, suppose we create dvs with default uplink port name as uplink,
    * uplink2, uplink3, ...
    */
      ...
      try {
         ...
         if (dvPorts != null && dvPorts.get(0) != null) {
            ...
            if (dvPortConfigInfo != null) {
               ...
               uplinkOrderPolicy = DVSUtil.getPortOrderPolicy(false,
                        new String[] { INVALID_PORTNAME_STR }, null);
               uplinkTeamingPolicy = DVSUtil.getUplinkPortTeamingPolicy(false,
                        null, null, null, null, null, uplinkOrderPolicy);
