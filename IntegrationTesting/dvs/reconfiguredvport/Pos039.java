 ...
 */
public class Pos039 extends CreateDVSTestBase
{
   ...
   {
      super.setTestDescription("Reconfigure DVPort name with a null");
   }
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  if (portKeyList != null && portKeyList.size() == DVS_PORT_NUM) {
                     ...
                     portConfigSpecs[0].setName(null);
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Reconfigure DVPort name with a null")
   public void test()
      throws Exception
   {
      log.info("Test Begin:");
