...
public class Pos002 extends CreateDVSTestBase
{
   ...
   private final int DVS_PORT_NUM = 2048;
   ...
   {
      super.setTestDescription("Reconfigure DVPort with multiple valid DVPorts");
   }
               ...
               if (this.dvsMOR != null) {
                  ...
                  if (portKeyList != null && portKeyList.size() == DVS_PORT_NUM) {
                     ...
                     for (int i = 0; i < DVS_PORT_NUM; i++) {
                        ...
                        portConfigSpecs[i].setName(getTestId() + i);
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Reconfigure DVPort with multiple valid DVPorts")
   public void test()
      throws Exception
   {
      log.info("Test Begin:");
