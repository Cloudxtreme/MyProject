...
public class Pos009 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure DVPort and set a valid "
               + "ComputerResource Mor in scope property");
   }
      ...
      throws Exception
   {
      ...
      ClusterComputeResource icr = null;
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  if (portKeyList != null && portKeyList.size() == DVS_PORT_NUM) {
                     ...
                     if (icr.getAllComputeResources() != null) {
                        ...
                        portConfigSpecs[0].getScope().addAll(com.vmware.vcqa.util.TestUtil.arrayToVector(new ManagedObjectReference[] { (ManagedObjectReference) (icr.getAllComputeResources().get(0)) }));
                        portConfigSpecs[0].setOperation(ConfigSpecOperation.EDIT.value());
                        status = true;
                     } else {
                        log.error("Can't get any valid compute resource");
                     }
                  } else {
