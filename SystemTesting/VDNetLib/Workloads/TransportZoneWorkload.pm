...
package VDNetLib::Workloads::TransportZoneWorkload;
...
#      VDNetLib::Workloads::VSMWorkload
#      class.
#
# Input:
...
sub new
{
   ...
   $self = {
      ...
      'targetkey'    => "testtransportzone",
      'managementkeys' => ['type', 'iterations','testtransportzone',
