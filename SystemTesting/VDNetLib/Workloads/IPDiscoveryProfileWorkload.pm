...
package VDNetLib::Workloads::IPDiscoveryProfileWorkload;
...
#      VDNetLib::Workloads:: IPDiscoveryProfileWorkload
#      class.
#
# Input:
...
#
# Results:
#      Returns a VDNetLib::Workloads::IPDiscoveryProfileWorkload object, if successful;
...
sub new {
   ...
   $self = {
      ...
      'targetkey'    => "testipdiscoveryprofile",
      'managementkeys' => [
         'type', 'iterations', 'testipdiscoveryprofile', 'expectedresult',
