...
package VDNetLib::Workloads::AuthServerWorkload;

#
# This package/module is used to run workload that involves executing
# Authentication Server operations. The supported operations are given in the
...
# The VDNetLib::VSM::AuthServerOperations object that this module
...
# Management keys:-
# ---------------
# Type      => "AuthServer" (this is mandatory and the value should be same)
...
#      VDNetLib::Workloads::AuthServerWorkload
#      class.
#
# Input:
...
#
# Results:
#      Returns a VDNetLib::Workloads::AuthServerWorkload object, if successful;
...
sub new
{
   ...
   $self = {
      ...
      'targetkey'    => "testauthserver",
      'managementkeys' => ['type','iterations','testauthserver','expectedresult',
                           'sleepbetweencombos','sleepbetweenworkloads'],
      'componentIndex' => undef
      };

    $vdLogger->Debug("Creating AuthServer Workload Object");
    bless ($self, $class);
