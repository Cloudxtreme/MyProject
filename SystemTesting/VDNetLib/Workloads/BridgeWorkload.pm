...
package VDNetLib::Workloads::BridgeWorkload;
...
#      VDNetLib::Workloads::BridgeWorkload
#      class.
#
# Input:
...
#
# Results:
#      Returns a VDNetLib::Workloads::BridgeWorkload object, if successful;
...
sub new {
   ...
   $self = {
      ...
      'targetkey'    => "testbridge",
      'managementkeys' => ['type', 'iterations','testbridge'],
