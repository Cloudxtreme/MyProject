package VDNetLib::Workloads::NetworkServicesWorkload;
...
#      VDNetLib::Workloads::NetworkServicesWorkload class
#
# Input:
...
#
# Results:
#      Returns VDNetLib::Workloads::NetworkServicesWorkload object, if successful;
...
sub new
{
   ...
   $self = {
      ...
      'targetkey'      => "testnetworkservices",
      'managementkeys' => ['type', 'iterations', 'testnetworkservices',
                          'expectedresult'],
