...
package VDNetLib::Workloads::DFWRuleWorkload;
...
#      VDNetLib::Workloads:: DFWRuleWorkload
#      class.
#
# Input:
...
#
# Results:
#      Returns a VDNetLib::Workloads:: DFWRuleWorkload object, if successful;
...
sub new {
   ...
   $self = {
      ...
      'targetkey'    => "testdfwrule",
      'managementkeys' => ['type', 'iterations', 'testdfwrule',
