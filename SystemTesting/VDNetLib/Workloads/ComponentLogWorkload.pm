...
###############################################################################
#
# package VDNetLib::Workloads::ComponentLogWorkload;
...
#      VDNetLib::Workloads::ComponentLogWorkload
#      class.
#
# Input:
...
#
# Results:
#      Returns a VDNetLib::Workloads::ComponentLogWorkload object, if successful;
...
sub new
{
   ...
   $self = {
      ...
      'targetkey'    => "testcomponentlog",
      'managementkeys' => ['type', 'iterations','testcomponentlog',
