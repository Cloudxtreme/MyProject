package VDNetLib::Workloads::UserWorkload;
...
#      VDNetLib::Workloads::UserWorkload class
#
# Input:
...
#
# Results:
#      Returns VDNetLib::Workloads::UserWorkload object, if successful;
...
sub new
{
   ...
   $self = {
      ...
      'targetkey'      => "testuser",
      'managementkeys' => ['type', 'iterations', 'testuser',
                          'expectedresult'],
