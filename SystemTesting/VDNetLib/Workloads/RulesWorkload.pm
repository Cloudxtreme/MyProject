...
###############################################################################
#
# package VDNetLib::Workloads::RulesWorkload;
# This package is used to run Rules workload that involves
#
#    -- operations related  to Rules in esx host.
#
...
sub new {
   ...
   $self = {
      ...
      'targetkey'      => "testrules",
      'managementkeys' => ['type', 'iterations', 'testrules'],
