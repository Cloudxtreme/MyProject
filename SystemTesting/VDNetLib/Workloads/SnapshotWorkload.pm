package VDNetLib::Workloads::SnapshotWorkload;
...
#      VDNetLib::Workloads::SnapshotWorkload class
#
# Input:
...
#
# Results:
#      Returns VDNetLib::Workloads::SnapshotWorkload object, if successful;
...
sub new
{
   ...
   $self = {
      ...
      'targetkey'      => "testsnapshot",
      'managementkeys' => ['type', 'iterations', 'testsnapshot',
                          'expectedresult'],
