...
package VDNetLib::Workloads::ProfileWorkload;
...
#      VDNetLib::Workloads::ProfileWorkload
#      class.
#
# Input:
...
#
# Results:
#      Returns a VDNetLib::Workloads::ProfileWorkload object, if successful;
...
sub new {
   ...
   $self = {
      ...
      'targetkey'    => "testprofile",
      'managementkeys' => ['type', 'iterations','testprofile'],
