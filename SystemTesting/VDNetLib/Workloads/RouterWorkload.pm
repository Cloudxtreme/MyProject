...
package VDNetLib::Workloads::RouterWorkload;
...
#      VDNetLib::Workloads:: RouterWorkload
#      class.
#
# Input:
...
#
# Results:
#      Returns a VDNetLib::Workloads:: RouterWorkload object, if successful;
...
sub new {
   ...
   $self = {
      ...
      'targetkey'    => "testrouter",
      'managementkeys' => ['type', 'iterations','testrouter'],
