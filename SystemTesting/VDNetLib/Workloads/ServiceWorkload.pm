...
package VDNetLib::Workloads::ServiceWorkload;
...
#      VDNetLib::Workloads::ServiceWorkload
#      class.
#
# Input:
...
sub new
{
   ...
   $self = {
      ...
      'targetkey'    => "testservice",
      'managementkeys' => ['type', 'iterations','testservice','expectedresult','sleepbetweencombos'],
