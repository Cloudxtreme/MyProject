...

{
   ...
   %VLAN = (
      'sVLAN' => {
                TestSet              => "VLAN",
                TestName             => "sVLAN",
                SupportedPlatforms   => "ESX40",
                UnSupportedPlatforms => "Hosted",
                SupportedDrivers     => "VMXNET3, VMXNET2, E!000",
                Tags                 => "PortableTools",
                NOOFMACHINES         => 2,
                SETUP                => "INTRA",
                TARGET               => "CONNECTION",
...
########################################################################
# new --
#       This is the constructor for VLANTds
#
# Input:
#       none
#
# Results:
#       An instance/object of VLANTds class
#
# Side effects:
#       None
#
