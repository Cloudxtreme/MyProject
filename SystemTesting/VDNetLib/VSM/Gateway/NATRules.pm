...
# All Rights Reserved
########################################################################
package VDNetLib::VSM::Gateway::NATRules;
...
sub GetInlinePyObject
{
   ...
   my $inlinePyObj = CreateInlinePythonObject('nat_rules.NATRules',
                                               $inlinePyEdgeObj,
                                               $endpoint_version,
                                             );
...
#    REST call for appending NAT Rules
#
# Side effects:
#     None
#
...
sub ProcessSpec
{
   ...
   $vdLogger->Info ("NATrulesArrayOfSpec".Dumper(\@newarrayOfSpec));
