...
package VDNetLib::VSM::GlobalMACSet;
#
# This package allows to create MACSet on universal scope
#

use base qw(VDNetLib::VSM::MACSet VDNetLib::Root::GlobalObject);
...
#
# Results:
#      An object of VDNetLib::VSM::GlobalMACSet
#
# Side effects:
#      None
#
...
sub GetInlinePyObject
{
   ...
   my $inlinePyObj = CreateInlinePythonObject('vsm_macset.MACSet',
                                               $inlinePyVSMObj,
                                               'universal'
                                             );
   if (!$inlinePyObj) {
...
########################################################################
#
# GetMacsetEndpointAttributes --
#      Method to make a server call for MACset endpoint and fetch the
...
sub GetMacsetEndpointAttributes
{
   my $self = shift;
