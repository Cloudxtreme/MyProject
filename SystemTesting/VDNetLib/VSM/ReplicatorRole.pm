...
# All Rights Reserved
########################################################################
package VDNetLib::VSM::ReplicatorRole;
...
sub GetInlinePyObject
{
   ...
   my $inlinePyObj = CreateInlinePythonObject('replicator_role.ReplicatorRole',
                                               $inlinePyVSMObj,
                                             );
