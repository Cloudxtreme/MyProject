...
# All Rights Reserved
########################################################################
package VDNetLib::VSM::Service::VersionedDeploymentSpec;
...
#     VDNetLib::VSM::VersionedDeploymentSpec
#
# Input:
#     vsm : vsm ip
#
...
sub GetInlinePyObject
{
   ...
   my $inlinePyObj = CreateInlinePythonObject('versioned_deployment_spec.VersionedDeploymentSpec',
                                               $inlinePyServiceObj,
                                             );
