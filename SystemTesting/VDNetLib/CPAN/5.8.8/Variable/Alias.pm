#
# This CPAN module has been modified by vdNet team
# to  fix  few of the bugs in the module. E.g. the 
# original  module  had the strict checks for  the
# perl version. They  were no t required and hence
# has been removed. Also in  the  original module,
# always the "$src"  variable used to get tied  to
# the Variable::Alias::SCALAR class, and there was
# a strict check if the datatype of source and the
# destination  variable are not  same,  the module
# used to return failure. That way, if we  try  to
# alias an already aliased  variable ,  it used to
# fail. Fixed that code too.
#
