...
# # All Rights Reserved
###############################################################################
package VDNetLib::Verification::VarLogVerification;

#
# This module gives object of VarLog verification. It deals with gathering
...
require Exporter;
# ISA was not doing multiple inheritance thus I am using use base which works
...
sub GetMyChildren
{
   # Var Log Verification has no children.
   return 0;
}
...
sub GetDefaultLogType
{
   ...
   # We can extend the nodes to get var/log/kern.log in future.
