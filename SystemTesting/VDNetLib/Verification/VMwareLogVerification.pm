...
# # All Rights Reserved
###############################################################################
package VDNetLib::Verification::VMwareLogVerification;

#
# This module gives object of VMware verification. It deals with gathering
...
sub GetMyChildren
{
   # VMware Log Verification has no children.
   return 0;
}
...
sub GetDefaultLogType
{
   ...
   $logTemple->{'win'}->{"vmware"} = $logTemple->{'linux'}->{"vmware"};
   return $logTemple;
}
