...
# # All Rights Reserved
###############################################################################
package VDNetLib::Verification::LACPLogVerification;

#
# This module gives object of LACP verification. It deals with gathering
# initial and final lacp logs before a test is executed and then taking a diff
...
sub GetMyChildren
{
   # LacpLogVerification has no children.
   return 0;
}
