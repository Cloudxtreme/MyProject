...
# # All Rights Reserved
###############################################################################
package VDNetLib::Verification::DmesgVerification;
...
sub GetMyChildren
{
   # Dmesg Verification has no children.
   return 0;
}
...
sub GetSupportedPlatform
{
   ...
   # This verification is supported inside the guest as well as on host.
   return "guest,host";
...
sub GetDefaultLogType
{
   ...
   $logTemple = {
      ...
      # TODO: Add PCAUSA tool to windows and collect logs.
   };
