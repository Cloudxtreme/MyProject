...
# All Rights Reserved
########################################################################
package VDNetLib::NSXManager::NodeBackupRestore;
...
#     VDNetLib::NSXManager::NodeBackupRestore
#
# Input:
...
sub new
{
   ...
   $self->{_pyclass} = 'vmware.nsx.manager.backuprestore.nodebackuprestore'.
   '.nodebackuprestore_facade.NodeBackupRestoreFacade';
   $self->{_pyIdName} = 'id_';
   bless $self;
   return $self;
}
