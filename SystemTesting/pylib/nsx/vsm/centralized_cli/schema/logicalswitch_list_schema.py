...
class LogicalSwitchListSchema(base_cli_schema.BaseCLISchema):
    _schema_name = "LogicalSwitchListSchema"
...
class LogicalSwitchEntrySchema(base_cli_schema.BaseCLISchema):
	...
	# as an attribute cannot have '-' in it
        ...
        self.uuid = "UUID"
        self.vni = "VNI"
        self.vdnscopename = "VdnScopeName"
        self.vdnscopeid = "VdnScopeId"

if __name__ == '__main__':
   schema = LogicalSwitchListSchema()
