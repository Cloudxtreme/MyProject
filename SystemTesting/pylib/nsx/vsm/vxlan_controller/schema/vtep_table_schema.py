...
class VTEPTableSchema(base_cli_schema.BaseCLISchema):
    ...
    def __init__(self, py_dict=None):
        """ Constructor to create VTEPTableSchema object
...
class VTEPTableEntrySchema(base_cli_schema.BaseCLISchema):
    _schema_name = "VTEPTableEntrySchema"
    def __init__(self, py_dict=None):
        """ Constructor to create VTEPTableEntrySchema object
