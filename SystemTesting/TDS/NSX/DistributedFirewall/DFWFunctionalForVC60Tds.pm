...
# # All Rights Reserved
#########################################################################
package TDS::NSX::DistributedFirewall::DFWFunctionalForVC60Tds;
...

{
   %DFWFunctionalForVC60 = (
      'RejectL3RuleForTCP'   => {
         ...
         Duration         => '100',
         Version          => '2' ,
         TestbedSpec      => COMMON_TESTBEDSPEC_VC_60_HOSTS_55_60,
         WORKLOADS => {
            Sequence => [
                    ['CreateUserSection'],
...
sub new
{
   my ($proto) = @_;
      ...
      my $self = $class->SUPER::new(\%DFWFunctionalForVC60);
