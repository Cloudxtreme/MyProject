...
# # All Rights Reserved
########################################################################
package TDS::EsxServer::FPT::SRIOVBe2NetTds;
   ...
   %SRIOV = (
      ...
      'PCILimit'   => {
         ...
         Parameters   => {
            ...
            "helper[1-2]" => {   # initializes helper1 and helper2
               vm => 1,
               pci => {
            ...
            "helper[3]" => {
               vm => 1,
               pci => {
                  "[1-3]" => {           # initializes 1-3 pci devices
                     passthrudevice => "SUT:vmnic:1",
                     virtualfunction => "any",
                  },
                  "[4-6]" => {           # initializes 4-6 pci devices
                     passthrudevice => "SUT:vmnic:2",
                     virtualfunction => "any",
                  },
               },
            },
            "helper[4-5]" => {   # initializes helper4 and helper5
               vm => 1,
               pci => {
                  "[1-6]" => {           # initializes 1-6 pci devices
                     passthrudevice => "SUT:vmnic:2",
      ...
      'JumboFrames'   => {
         ...
         Tags             => "be2net,linuxOnly",
         Summary          => "This test case verifies that VF to VF ".
                             "communication using jumbo frames",
         ExpectedResult   => "PASS",
         Parameters   => {
            SUT   => {
               vmnic => [
         ...
         WORKLOADS => {
            ...
            "UDPTraffic" => {
               ...
               NoofInbound               => "1",
               NoofOutbound              => "1",
               SendMessageSize           => "2048,4096,8192," .
                                            "16384,32768,64512",
               LocalSendSocketSize       => "131072",
               RemoteSendSocketSize      => "131072",
               Verification              => "Verification_1",
