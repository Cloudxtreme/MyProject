...
/**
 * Update a existing vnic to connect to an standalone port on an existing
 * DVSwitch. The distributedVirtualPort is of type DVSPortConnection. Build a
 * DVPortConnection with invalid DVPortKey. The distributedVirtualPort is of
...
public class Neg001 extends VNicBase
{
   ...
   {
      setTestDescription("Update a existing  vnic to connect"
    ...
    */
   @Test(description = "Update a existing  vnic to connect"
               + " to an  standalone port on an existing DVSwitch. "
               + "The distributedVirtualPort is of type DVSPortConnection.\n"
               + "Build a DVPortConnection with invalid DVPortKey.")
   public void test()
