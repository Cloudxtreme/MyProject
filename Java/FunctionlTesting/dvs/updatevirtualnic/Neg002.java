...
/**
 * Update an existing vnic to connect to an earlyBinding DVPortgroup on an
 * existing DVSwitch. The distributedVirtualPort is of type
 * DistributedVirtualSwitchPortConnection. A invalid early binding DVportgroup
 */
