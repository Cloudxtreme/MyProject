...
/**
 * Update an existing virtual nic to connect to an existing DVPort on an
 * ephemeral DVportgroup on an existing DVSwitch. The distributedVirtualPort is
 * of type DVSPortConnection.
 */
public class Pos016 extends VNicBase
{
   ...
   {
      setTestDescription("Update an existing  virtual to connect to an "
               + "late  DVPort on an ephemeral DVportgroup on an "
               + "existing DVSwitch.\n"
    ...
    */
   @Test(description = "Update an existing  virtual to connect to an "
               + "late  DVPort on an ephemeral DVportgroup on an "
               + "existing DVSwitch.\n"
               + " The distributedVirtualPort is of type DVSPortConnection. ")
   public void test()
