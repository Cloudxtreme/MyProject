...
/**
 * DESCRIPTION:Enable netiorm and add a network resource pool on the dvs with
 * config version as null<BR>
 * TARGET: VC <BR>
 * SETUP:<BR>
 ...
 * 3. Enable netiorm <BR>
 * TEST:<BR>
 * 4. Add a nrp with config version as null on the dvs<BR>
 * 5. Verify the nrp from the dvs <BR>
 * 6. Add a host to the dvs and verify from the net-dvs command <BR>
 * 7. Add a free pnic to the dvs and verify vsi state on the dvs <BR>
 * 8. Move all pnics to dvs and verify vsi state <BR>
 * 9. Add another host to dvs and verify net-dvs command <BR>
 * CLEANUP:<BR>
 * 10. Restore the hosts <BR>
 * 11. Destroy the dvs<BR>
 */
public class Pos002 extends TestBase
{
    ...
    * Test method
    */
   @Test(description = "Add a network resource pool on the dvs with configVersion = null")
   public void test()
      throws Exception
   {
   ...
   {
      setTestDescription("Add a network resource pool on the dvs with configVersion = null");
   }
