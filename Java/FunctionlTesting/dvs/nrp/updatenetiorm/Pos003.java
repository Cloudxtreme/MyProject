...
public class Pos003 extends TestBase
{
    ...
    */
   @Override
   @Test(description = "Configure a NRP for iscsi")
   public void test()
      throws Exception
   {
      ...
      throws Exception
   {
      ...
      nrp = idvs.extractNetworkResourcePool(dvsMor, DVSTestConstants.NRP_ISCSI);

      // assert if nrp is null
      Assert.assertNotNull(nrp, "Could not find nrp for iscsi");
   ...
   {
      setTestDescription("Configure a NRP for iscsi");
   }
