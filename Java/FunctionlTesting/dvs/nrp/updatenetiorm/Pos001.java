...
/**
 * Configure a NRP for vm traffic.
 */
public class Pos001 extends TestBase
{
    ...
    */
   @Override
   @Test(description = "Configure a NRP for vm traffic")
   public void test()
      throws Exception
   {
      ...
      throws Exception
   {
      ...
      if (hostIterator.hasNext()) {
         ...
         this.srcHostProfile1  = NetworkResourcePoolHelper.extractHostConfigSpec(
      ...
      Assert.assertNotNull(nrp, "Could not find nrp for virtual machine");
