 ...
 * number - DVSPortSetting.blocked to false - DVSPortSetting.mtu to 9000
 */

public class Pos082 extends CreateDVSTestBase
{
   /*
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  vmwareDVSConfigSpec.setMaxMtu(9000);
