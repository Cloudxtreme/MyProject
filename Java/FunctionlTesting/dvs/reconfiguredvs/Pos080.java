 ...
 * DVSConfigSpec.maxPorts to 0 - DVSConfigSpec.uplinkPortPolicy to { name to the
 * maximal number of chars (80 chars), uplink2, uplink3}
 */
public class Pos080 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS by setting the \n"
               ...
               + " - DVSConfigSpec.uplinkPortPolicy to {name to the maximal "
               + " number of chars (80 chars)");
   }
