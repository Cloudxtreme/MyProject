 ...
 * number - DVSPortSetting .blocked to false - inShapingPolicy.enabled to true -
 * inShapingPolicy.peakBandWidth set to a negative number
 */

public class Neg043 extends CreateDVSTestBase
{
   /*
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVSwitch by setting:\n "
               ...
               + " - inShapingPolicy.enabled to true,\n"
               + " - inShapingPolicy.peakBandWidth to to a negative value.");
   }
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  inShapingPolicy.setPeakBandwidth(DVSUtil.getLongPolicy(false,
                           new Long(-1)));
                  this.deltaConfigSpec.setConfigVersion(dvsInfo.getConfigVersion());
                  this.deltaConfigSpec.setMaxPorts(11);
                  this.deltaConfigSpec.setNumStandalonePorts(5);
