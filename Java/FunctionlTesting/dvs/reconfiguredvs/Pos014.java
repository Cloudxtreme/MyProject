 ...
 * numPort - Set DVSConfigSpec.numPort to a valid equal to the number of pnics
 * being added - Set DVSConfigSpec.uplinkPortPolicy to a valid array that has
 * number of elements equal to the number of pnics being added({uplink1, ..
 * uplink(n)}) - Set DistributedVirtualSwitchHostMemberConfigSpec.operation to
 * ADD - Set DistributedVirtualSwitchHostMemberConfigSpec.host to a valid
 * hostMor - Set DistributedVirtualSwitchHostMemberConfigSpec.proxy to a valid
 * pnic proxy selection with the pnic spec(s) containing a valid pnic key and a
 * null value for uplinkPortKey - Set
...
public class Pos014 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS as follows:\n"
               ...
               + " numPort\n"
               + "  - Set DVSConfigSpec.numPort to a valid equal to the number of pnics "
               + "being added\n"
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  String[] uplinkPortNames = new String[physicalNics.length];
                  ...
                  this.deltaConfigSpec.setMaxPorts(2 * uplinkPortNames.length);
