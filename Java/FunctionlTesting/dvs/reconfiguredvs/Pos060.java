...
public class Pos060 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS as follows:\n"
               + " - Set the DVSConfigSpec.configVersion to a valid config "
               + "version string,\n"
               + " - Set DVPortSetting.blocked to false,\n"
               + " - Set DVPortSetting.pvlanID to a primary pvlanId that belongs "
               + "to the pvlanMapEntry, promiscuous type.");
   }
               ...
               if (this.dvsMOR != null) {
                  ...
                  if (configInfo.getDefaultPortConfig() instanceof VMwareDVSPortSetting) {
                     ...
                     if (iVmwareDVS.addPrimaryPvlan(dvsMOR, PVLAN1_PRI_1)) {
                        if (iVmwareDVS.isPvlanIdPresent(this.dvsMOR,
                                 PVLAN1_PRI_1)) {
                           ...
                           pvlanSpec.setPvlanId(PVLAN1_PRI_1);
