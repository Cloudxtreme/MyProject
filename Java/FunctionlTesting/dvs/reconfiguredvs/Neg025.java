...
/**
 * Remove a host connected to the DVSwitch, without removing the virtaul nic
 * that is connected to the dv switch.
 */

public class Neg025 extends CreateDVSTestBase
{
   /*
   ...
   {
      super.setTestDescription("Remove a host connected to the dv switch "
               + "without removing the virtual nic connected "
               + "to the dv switch");
   }
                     ...
                     if (portConnection != null) {
                        ...
                        if (!this.ihs.isEesxHost(hostMor)) {
                           ...
                           String ipAddress = TestUtil.
                              getAlternateServiceConsoleIP(this.ihs.
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Remove a host connected to the dv switch "
               + "without removing the virtual nic connected "
               + "to the dv switch")
   public void test()
      throws Exception
      ...
      throws Exception
   {
      boolean status = false;
         ...
         if (this.iNetworkSystem.removeVirtualNic(this.iNetworkMor, vnicId)) {
