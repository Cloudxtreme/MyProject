...
/**
 * Reconfigure an existing DVS by setting the - DVSContactInfo.name to The
 * maximal number of chars (i.e. 128)
 */
public class Pos084 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS by setting the \n"
               + " - DVSContactInfo.name to MaxAdminName(The maximal number of chars (i.e. 128)\n");
   }
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  contactInfo.setName((DVSTestConstants.DVPORTGROUP_VALID_NAME_31_CHARS
