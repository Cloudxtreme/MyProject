 ...
 * string and name to "abcdefghijklmnopqrstuvwxyzabcdef" (a string with more
...
public class Neg007 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVSwitch by setting "
               ...
               + " to 'abcdefghijklmnopqrstuvwxyzabcdef' (a string with more than 31"
               + " characters) long.");
   }
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  this.deltaConfigSpec.setName(DVSTestConstants.INVALID_NAME_260_CHARS);
                  status = true;
               } else {
