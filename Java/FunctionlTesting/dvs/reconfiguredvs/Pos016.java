 ...
 * numPort - Set DVSConfigSpec.numPort to a valid more than the number of uplink
 * ports per host. - Set DVSConfigSpec.uplinkPortPolicy to a valid array that
 * has number of elements equal to the number of pnics being added({uplink1, ..
