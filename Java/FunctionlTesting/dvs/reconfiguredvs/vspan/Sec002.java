...
/**
 * DESCRIPTION:<br>
 * Edit a VSPAN session to the DVS by a user having "DVSwitch.Vspan" privilege.<br>
 * <br>
 * SETUP:<br>
 * 1. Create a DVS.<br>
 ...
 * <br>
 * TEST:<br>
 * 4. Reconfigure the DVS to EDIT the VSPAN session successfully.<br>
 * CLEANUP:<br>
 * 5. Destroy the DVS.<br>
 */
public class Sec002 extends VspanTestBase
{
   ...
   @Test(description = "Edit a VSPAN session to the DVS by a user having"
