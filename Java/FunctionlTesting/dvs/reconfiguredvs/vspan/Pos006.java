 ...
 * destination having DVPort key and uplink port name.<br>
 ...
 */
public class Pos006 extends VspanTestBase implements IDataDrivenTest
{
   @Override
      ...
      throws Exception
   {
      ...
      final VMwareVspanPort vspanPort = VspanHelper.buildVspanPort(
               ports.get(0), null, VspanHelper.popPort(uplinkPortgroups));
