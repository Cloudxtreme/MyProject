 ...
 * and Rx with destination as valid port key and valid uplink port name.<br>
 * <br>
 * SETUP:<br>
 ...
 */
public class Pos015 extends VspanTestBase implements IDataDrivenTest
{
   ...
   @Test(description = "Add a VSPAN session to the DVS by providing "
            ...
            + "destination as valid port key and valid uplink port name.")
   @Override
   public void test()
      throws Exception
   {
      ...
      final VMwareVspanPort vspanPort = VspanHelper.buildVspanPort(ports.get(0),
               null, VspanHelper.popPort(uplinkPortgroups));
