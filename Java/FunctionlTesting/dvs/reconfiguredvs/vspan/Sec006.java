...
/**
 * DESCRIPTION:<br>
 * Remove a VSPAN session in DVS by user NOT having "DVSwitch.Vspan" privilege.<br>
 * <br>
 * SETUP:<br>
 * 1. Create a DVS.<br>
 * 2. Add a VSPAN session.<br>
 * 3. Login with Test user without "DVSwitch.Vspan" privilege.<br>
 * <br>
 * TEST:<br>
 * 4. Reconfigure the DVS to REMOVE the VSPAN session.<br>
 * 5. Expect NoPermission Falult.<br>
 * CLEANUP:<br>
 * 6. Destroy the DVS.<br>
 */
public class Sec006 extends VspanTestBase
{
   ...
   @Test(description = "REMOVE a VSPAN session in DVS by a user NOT having"
