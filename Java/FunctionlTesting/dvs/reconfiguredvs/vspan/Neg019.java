...
/**
 * DESCRIPTION:<br>
 * Verify that we can't set any value to sourceRx.uplinkPortName.
 */
public class Neg019 extends VspanTestBase
{
      ...
      throws Exception
   {
      ...
      final VMwareVspanPort sourcePortRx;
      sourcePortRx = VspanHelper.buildVspanPort(null, null, "123456");
      vspanCfg[0] = VspanHelper.buildVspanCfg(VspanHelper.buildVspanSession(
               getTestId(), null, sourcePortRx, null), CONFIG_SPEC_ADD);
