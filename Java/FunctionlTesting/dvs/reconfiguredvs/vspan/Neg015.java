...
/**
 * DESCRIPTION:<br>
 * Edit a VSPAN session in a DVS by providing invalid port key for mirroring Rx.
 */
public class Neg015 extends VspanTestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Edit a VSPAN session in a DVS by providing "
               + "invalid port key for mirroring Rx.");
   }
      ...
      throws Exception
   {
      try {
         ...
         for (int i = 0; i < existingSessions.length; i++) {
            ...
            aSession.setSourcePortReceived(VspanHelper.buildVspanPort("56756",
                     null, null));
