...
/**
 * DESCRIPTION:<br>
 * Edit a VSPAN session in a DVS by providing invalid port key for mirroring Tx.
 */
public class Neg014 extends VspanTestBase
{
      ...
      throws Exception
   {
      try {
         ...
         for (int i = 0; i < existingSessions.length; i++) {
            ...
            aSession.setSourcePortTransmitted(VspanHelper.buildVspanPort("56756",
                     null, null));
