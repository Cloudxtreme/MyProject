...
/**
 * DESCRIPTION:<br>
 * Edit a VSPAN session in a DVS by providing invalid VSPAN key.
 */
public class Neg012 extends VspanTestBase
{
   ...
   {
      setTestDescription("Edit a VSPAN session in a DVS by providing invalid " +
      "VSPAN key.");
   }
   ...
   @Test(description = "Edit a VSPAN session in a DVS by providing invalid " +
      "VSPAN key.")
   @Override
   public void test()
   throws Exception
