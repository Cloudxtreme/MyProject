 ...
 * DVSConfigSpec.maxPorts to 0 - DVSConfigSpec.uplinkPortPolicy to {a valid
 * numeric name, uplink2, uplink3}
 */
public class Pos076 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS by setting the \n"
               ...
               + " - DVSConfigSpec.uplinkPortPolicy to { a valid numeric name");
   }
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  String[] uplinkPortNames = { DVSTestConstants.ALL_NUM_STRING,
                           "uplink2", "uplink3" };
