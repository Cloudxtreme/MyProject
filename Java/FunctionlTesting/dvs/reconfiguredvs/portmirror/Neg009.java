...
public class Neg009 extends PortMirrorTestBase {
	...
	@Test(description = "Test invalid mirror packet length.")
	@Override
	public void test() throws Exception {
		try {
         ...
         if (target != null) {
         	target.getVspanSession()
         			.setMirroredPacketLength(mirrorPacketLength);
