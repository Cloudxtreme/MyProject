 ...
 * for uplinkPortKey
 */
public class Pos046 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure an existing DVS as follows:\n"
               ...
               + " with the pnic spec(s) containing a valid pnic key and a valid "
               + "uplinkPortKey.");
   }
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  if (physicalNics != null) {
                     ...
                     pnicSpec.setUplinkPortKey(this.iDistributedVirtualSwitch.getFreeUplinkPortKey(
