...
/**
 * Move a DVPort by providing a null MOR. This test is a Functional Feature
 * Acceptance Test (FFAT).
 */
public class Neg001 extends MovePortBase
{
   /**
   ...
   {
      setTestDescription("Move a DVPort by providing a null MOR.");
   }
   ...
   /**
    * Test. Move the DVPort to DVPortgroup by providing null DVS MOR.
    * 
    * @param connectAnchor ConnectAnchor.
    */
   @Override
   @Test(description = "Move a DVPort by providing a null MOR.")
   public void test()
      throws Exception
   {
      boolean status = false;
      ...
      try {
         movePort(null, portKeys, portgroupKey);
