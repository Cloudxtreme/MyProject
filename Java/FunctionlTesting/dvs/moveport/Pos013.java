...
/**
 * Move a DVPort connected to a powered on VM from the late binding DVPortGroup
 * with livePortMovingAllowed flag set to true, to another late binding
 * DVPortGroup.
 */
public class Pos013 extends MovePortBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Move a DVPort connected to a powered on VM from "
               + "the late binding DVPortGroup with livePortMovingAllowed "
               + "flag set to true, to another late binding DVPortGroup.");
   }

   /**
    * Test setup. 1. Create DVS. 2. Get A VM, used for connecting the DVPort to
    * be moved. 3. Create late binding DVPortgroup with
    * livePortMovingAllowed=true and connect the VM to a DVPort in it and use it
    * as port to be moved. 5. Create another late binding DVPortGroup and use it
    * as destination.
    * 
