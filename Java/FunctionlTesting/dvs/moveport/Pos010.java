 ...
 * with livePortMovingAllowed flag set to true, to a early binding DVPortGroup.
 * This test is a Functional Feature Acceptance Test (FFAT).
 */
public class Pos010 extends MovePortBase
{
   ...
   private DistributedVirtualSwitchPortConnection connection = null;

   private List<DistributedVirtualSwitchPortConnection> connectionList = new Vector<DistributedVirtualSwitchPortConnection>();;
   ...
   public void setTestDescription()
   {
      setTestDescription("Move a DVPort connected to a powered on VM from "
               ...
               + "flag set to true, to a early binding DVPortGroup.");
   }
    ...
    * as port to be moved. 4. Create another early binding DVPortGroup and use
    * it as destination.
    * 
            ...
            if (hostMor != null) {
               ...
               if ((dvsMor != null) && (vms != null) && (vms.size() >= 1)) {
                  ...
                  if (portgroupKeys != null) {
                     ...
                     connection = DVSUtil.buildDistributedVirtualSwitchPortConnection(
                              iDVSwitch.getConfig(dvsMor).getUuid(),
