 ...
 * VM, used for connecting the DVPort to be moved. 3. Create late binding
 * DVPortgroup with livePortMovingAllowed = true and connect the VM to a DVPort
 * in it and use it as port to be moved. 4. Verify power ops the VM. 5. Create
 * early binding DVPortGroup with livePortMovingAllowed = false and use it as
 * destination. Test: 6. Move the DVPort to destination, Should fail. Cleanup:
 * 7. Delete the DVS and logout.
 */
public class Pos046 extends MovePortBase
{
