 ...
 * in it's default settings to a late binding DVPortgroup with
 * settingShapingOverrideAllowed=false. Procedure: Setup: 1. Create a DVS. 2.
 * Create an early binding DVPortgroup having valid outShapingPolicy. 3. Create
 * a late binding DVPorgroup with ShapingOverrideAllowed=false. Test: 4. Move
 * the DVPort from first to second DVPortgroup. Cleanup: 5. Delete the DVS.
 */
public class Neg044 extends MovePortBase
{
   /**
