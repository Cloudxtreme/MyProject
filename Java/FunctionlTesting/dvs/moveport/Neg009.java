...
/**
 * Move a DVPort by providing invalid portgroupKey.
 */
public class Neg009 extends MovePortBase
{
   /**
   ...
   {
      setTestDescription("Move a DVPort by providing invalid portgroupKey.");
   }
   ...
   /**
    * Test. Move the DVPort in the DVPortgroup by providing invalid DVPortgroup
    * key.
    * 
    * @param connectAnchor ConnectAnchor.
    */
   @Override
   @Test(description = "Move a DVPort by providing invalid portgroupKey.")
   public void test()
      throws Exception
   {
      boolean status = false;
