...
/**
 * Move a standalone DVPort connected to a powered off VM to late binding
 * DVPortGroup with livePortMovingAllowed flag set to false.
 */
public class Neg046 extends MovePortBase
{
    ...
    * late binding DVPortgroup with livePortMovingAllowed=true and use it as
    * destination.
    * 
      ...
      throws Exception
   {
      ...
      try {
         ...
         log.error("Successfully moved the port");
