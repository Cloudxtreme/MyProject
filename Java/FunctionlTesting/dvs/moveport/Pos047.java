 ...
 * Create early binding DVPortgroup with livePortMovingAllowed = true and
 * connect the VM to a DVPort in it and use it as port to be moved.</br> 4.
 * Verify power ops the VM. 5. Create late binding DVPortGroup with
 ...
 * DVS and logout.</br>
 */
public class Pos047 extends MovePortBase
{
