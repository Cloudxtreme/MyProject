...
/**
 * Move a standalone DVPort connected to a powered off VM to early binding
 * DVPortGroup with livePortMovingAllowed flag set to false.
 */
public class Pos036 extends MovePortBase
{
    ...
    * early binding DVPortgroup with livePortMovingAllowed=true and use it as
    * destination.
    * 
