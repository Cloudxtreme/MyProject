...
/**
 * Move a standalone DVPort in DVS connected to a powered off VM to DVS itself.
 ...
 * standalone DVPort. Test: 5. Move the standalone DVPort to the DVS. Cleanup:
 * 6. Reconfigure the VM to bring it to previous state. 7. Delete the DVS.
 */
public class Pos034 extends MovePortBase
{
