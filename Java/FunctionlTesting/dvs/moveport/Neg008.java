...
/**
 * Move a DVPort by providing empty portgroupKey.
 */
public class Neg008 extends MovePortBase
{
   /**
   ...
   {
      setTestDescription("Move a DVPort by providing empty portgroupKey.");
   }
   ...
   /**
    * Test. Move the DVPort in the DVPortgroup by providing empty DVPortgroup
    * key.
    * 
    * @param connectAnchor ConnectAnchor.
    */
   @Override
   @Test(description = "Move a DVPort by providing empty portgroupKey.")
   public void test()
      throws Exception
   {
      boolean status = false;
