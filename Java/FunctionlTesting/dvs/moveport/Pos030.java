...
/**
 * Move a standalone DVPort in DVS connected to a powered off VM to an early
 ...
 * VM to bind to the standalone DVPort. 4. Create early binding DVPortgroup and
 * use it's key as destination. Test: 5. Move the standalone DVPort to the early
 * binding DVPortgroup. Cleanup: 6. Reconfigure the VM to bring it to previous
 * state. 7. Delete the DVS.
 */
public class Pos030 extends MovePortBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Move a standalone DVPort in DVS connected to a "
               + "powered off VM to an early binding DVPortgroup.");
   }
