 ...
 * Move the DVPort to destination, Should fail.</br> 7. Power off the VM and
 * Move the DVPort, Should fail.</br> Cleanup:</br> 8. Delete the DVS and
 * logout.</br>
 */
public class Pos039 extends MovePortBase
{
