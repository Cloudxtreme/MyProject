 ...
 * ops the VM.</br> 5. Create early binding DVPortGroup with
 * livePortMovingAllowed=true and use it as destination.</br> Test:</br> 6. Move
 * the DVPort to destination, Should fail.</br> Cleanup:</br> 7. Delete the DVS
 * and logout.</br>
 */
public class Pos043 extends MovePortBase
{
