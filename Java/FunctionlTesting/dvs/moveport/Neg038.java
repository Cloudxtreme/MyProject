...
/**
 * Move a DVPort which has Settings with valid inShapingPolicy to a late binding
 * DVPortgroup with settingShapingOverrideAllowed=false.
 */
public class Neg038 extends MovePortBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Move a DVPort which has Settings with valid "
               + "inShapingPolicy to a late binding DVPortGroup with "
    ...
    * reconfigure it to set valid inShapingPolicy and use it as the port to be
    * moved.
    * 
