...
public class Pos010 extends TestBase {
	...
	public void setTestDescription() {
		super.setTestDescription("Test import API with applyToEntitySpecified import type of reconfiguring DVS with port groups\n"
	 ...
	 */
	@Override
	@Test(description = "Test import API with applyToEntitySpecified import type of reconfiguring DVS with port groups\n"
			+ " 1. Create 2 DVS (DVS1 and DVS2)\n"
			+ " 2. create a VM with 2 vNics\n"
			+ " 3. Export DVS1 configuration\n"
			+ " 4. Reconfigure DVS2 configuration\n"
	...
	public void test() throws Exception {
		...
		try {
			...
			if (freePnics != null && freePnics.length >= 2) {
				...
				reconfigureDVPortgroup(dvpg2Mor);
				dvpg2Config = iDVSMgr.exportEntity(dvsManagerMor,
						dvpg2SelectionSet);
				idvpg.destroy(dvpg2Mor);
				dvpg2Config[0].setKey(dvpg1Config[0].getKey());
				iDVSMgr.importEntity(dvsManagerMor, dvpg2Config,
