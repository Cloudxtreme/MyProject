...
public class Pos006 extends TestBase {
	...
	public void setTestDescription() {
		super.setTestDescription("Test import operation on DVS with no port groups using createWithOriginalIdentifier import type"
	 ...
	 */
	@Override
	@Test(description = "Test import operation on DVS with no port groups using createWithOriginalIdentifier import type"
			+ " 1. Create 2 DVS (DVS1 and DVS2)\n"
			+ " 2. create ephemeral portgroups DVS1PG on DVS1 and DVS2PG on DVS2\n"
			+ " 3. create a VM with 2 vNics\n"
			+ " 4. Define DVS1PG as the backing for vNic1 and DVS2PG as the backing for vNic2\n"
	...
	public void test() throws Exception {
		...
		try {
			...
			if (freePnics != null && freePnics.length >= 2) {
				...
				/* Delete the vDS configuration */
				deleteDVSConfiguration();
				dvsMorList.clear();
