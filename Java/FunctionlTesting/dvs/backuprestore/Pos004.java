 ...
 * DVS2)\n) 2. create ephemeral port groups DVPG1 on DVS1 and DVPG2 on DVS2 3.
...
public class Pos004 extends TestBase {
	...
	public void setTestDescription() {
		super.setTestDescription("Test Export/Import operation of MN VDS on MN.next host\n"
	 ...
	 */
	@Override
	@Test(description = "Test Export/Import operation of MN VDS on MN.next host\n"
			+ " 1. Create 2 MN version DVS'es (DVS1 and DVS2)\n"
			+ " 2. create ephemeral portgroups DVPG1 on DVS1 and DVPG2 on DVS2\n"
			+ " 3. create a VM with 2 vNics\n"
			+ " 4. Define DVPG1 as the backing for vNic1 and DVPG2 as the backing for vNic2\n"
