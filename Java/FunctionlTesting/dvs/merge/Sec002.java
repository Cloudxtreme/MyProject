 ...
 * dvswitch and no DVSwitch.Delete" privilege on the second dvswitch.
 */
public class Sec002 extends TestBase
{
   ...
   private final String privilege = DVSWITCH_DELETE;
   ...
   public void setTestDescription()
   {
      setTestDescription("Create two dvswitches with the default configuration. "
               ...
               + " no DVSwitch.Delete privilege on the second dvswitch.");
   }
      ...
      throws Exception
   {
      ...
      // setting required permissions on destination DVS.
      authHelper.setPermissions(destDvsMor, DVSWITCH_MODIFY, testUser, false);
      // set exclude privileges on source DVS.
      authHelper.setExcludePrivileges(true);
      authHelper.setPermissions(srcDvsMor, privilege, testUser, false);
...
try {
   ...
   public MethodFault getExpectedMethodFault()
   {
      ...
      expectedFault.setObject(srcDvsMor);
