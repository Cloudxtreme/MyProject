...
/**
 * Merge two dvswitches with the second dvswitch MOR set to an empty object
 */
public class Neg008 extends TestBase
{
   ...
   {
      setTestDescription("Merge two dvswitches with the second dvswitch MOR "
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Merge two dvswitches with the second dvswitch MOR "
               + "set to an empty object")
   public void test()
      throws Exception
   {
      ...
      try {
         if (this.iDVSwitch.merge(this.destDvsMor, new ManagedObjectReference())) {
