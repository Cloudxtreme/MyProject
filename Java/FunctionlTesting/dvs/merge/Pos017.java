 ...
 * dest_defaultPortConfig with Valid securityPolicy (allowPromiscuous = true,
 * forgedTransmits = true, macChanges = true), valid src_defaultPortConfig Valid
 * securityPolicy (allowPromiscuous = false, forgedTransmits = false, macChanges
 * = false. Merge the two dvswitches.
 */
public class Pos017 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Create two dvswitches with the following "
               + "configuration: dest_defaultPortConfig with Valid "
               + "securityPolicy,  valid src_defaultPortConfig with valid "
               + "security policy. Merge the two dvswitches.");
   }
      ...
      throws Exception
   {
      ...
      log.info("Test setup Begin:");
         ...
         if (this.rootFolder != null) {
            ...
            securityPolicy = DVSUtil.getDVSSecurityPolicy(false, false, false,
                     false);
            this.dest.setSecurityPolicy(securityPolicy);
