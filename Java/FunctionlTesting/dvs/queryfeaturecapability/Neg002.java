 ...
 * 3.Set the productSpec with version as invalid string<BR>
 * TEST:<BR>
...
public class Neg002 extends TestBase implements IDataDrivenTest 
{
   ...
   public void setTestDescription()
   {
      setTestDescription("1)Invoke querySupportedSwitchSpec to"
               ...
               + "2)Get the productSpec  for new vDs version\n"
               + "3) Set the productSpec with version as invalid string \n"
      ...
      throws Exception
   {
      ...
      switchProductSpec.setVersion("0.0");
      return true;
   }
