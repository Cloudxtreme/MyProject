 ...
 * an existing DVSwitch.The distributedVirtualPort is of type
...
public class Pos003 extends VNicBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a vmkernel vnic to connect to an "
               + "existing DVPort on an earlyBinding portgroup on an existing "
               + "DVSwitch.The DVPort is of type DistributedVirtualSwitchPortConnection.Select this "
