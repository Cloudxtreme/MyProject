...
/**
 * Add a vnic to connect to an existing DVPort on an earlyBinding DVPortgroup on
 * an existing DVSwitch. The distributedVirtualPort is of type DVSPortgroup
 * Connection. Build DVPortConnection with valid DVPortKey on earlybinding
...
public class Neg003 extends VNicBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a vnic to connect to an "
               + "existing DVPort on an earlyBinding DVPortgroup on an existing  "
               + "DVSwitch. The distributedVirtualPort is of type DVSPort "
               + "Connection. Build DVPortConnection with valid DVPortKey on "
               + "earlybinding portgroup and invalid DVPortgroup Key.");
   }

   /**
    * Method to setup the environment for the test. 1. Create the DVSwitch. 2.
    * Get the earlyBinding DVPortKey. 3. Build the DVPortConnection. 4. Create
