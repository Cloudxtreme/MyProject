 ...
 * earlybinding DVPortgroupKey and DVPortKey as null.
 */
public class Neg002 extends VNicBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a service console vnic to connect to an "
               ...
               + "Build DVPortConnection with invalid earlyBinding PortgroupKey "
            ...
            if ((hostNetworkConfig != null) && (hostNetworkConfig.length == 2)
               ...
               if (networkUpdated) {
                  ...
                  if (portgroupKey != null) {
                     ...
                     log.error("Failed to get the DVPortgroupKey.");
                  }
               } else {
