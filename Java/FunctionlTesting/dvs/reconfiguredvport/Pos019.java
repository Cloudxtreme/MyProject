...
public class Pos019 extends CreateDVSTestBase
{
   ...
   {
      super.setTestDescription("Reconfigure DVPort with valid outShapingPolicy");
   }
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Reconfigure DVPort with valid outShapingPolicy")
   public void test()
      throws Exception
   {
      log.info("Test Begin:");
   ...
   /**
    * Create DVPort and set a valid outShapingPolicy
    */
