 ...
 */
public class Neg005 extends CreateDVSTestBase
{
   ...
   {
      super.setTestDescription("Set peakBandWidth of inShapingPolicy to "
               + "negative value");
   }
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Set peakBandWidth of inShapingPolicy to "
               + "negative value")
   public void test()
      throws Exception
   {
