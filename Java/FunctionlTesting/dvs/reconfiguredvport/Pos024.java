...
public class Pos024 extends CreateDVSTestBase
{
   ...
   private final int SECONDARY_PVLAN_ID = 2;
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Reconfigure DVPort and set pvlanid to secondary "
               + "pvlan id belongs to the pvlanMapEntry isolated type");
   }
   ...
   private void reconfigVmwareDVS(ManagedObjectReference dvsMor)
      throws Exception
   {
      VMwareDVSPvlanConfigSpec[] pvlanConfigSpecs = new VMwareDVSPvlanConfigSpec[2];
      ...
      pvlanMapEntry.setPrimaryVlanId(PRIMARY_PVLAN_ID);
      pvlanMapEntry.setSecondaryVlanId(SECONDARY_PVLAN_ID);
      ...
      try {
         ...
         if (dvPorts != null && dvPorts.get(0) != null) {
            ...
            if (dvPortConfigInfo != null) {
               ...
               pvlanSpec.setPvlanId(SECONDARY_PVLAN_ID);
