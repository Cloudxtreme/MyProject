...
public class Pos016 extends CreateDVSTestBase
{
   ...
   {
      super.setTestDescription("Reconfigure DVPort from early binding "
               + "portgroup. Set property VMwareDVSPortSetting.blocked to true");
   }
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  this.iDVS.addPortGroup(dvsMOR, "earlyBinding", DVS_PORT_NUM,
                           getTestId());
                  ...
                  if (portKeyList != null && portKeyList.size() == DVS_PORT_NUM) {
                     ...
                     portCriteria.getPortKey().addAll(com.vmware.vcqa.util.TestUtil.arrayToVector(new String[] { portKeyList.get(0) }));
                     dvPorts = this.iDVS.fetchPorts(dvsMOR, portCriteria);
                     if (dvPorts != null && dvPorts.get(0) != null) {
                        ...
                        dvPortSetting.setBlocked(DVSUtil.getBoolPolicy(false,
                                 new Boolean(true)));
                        portConfigSpecs[0].setSetting(dvPortSetting);
                     } else {
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Reconfigure DVPort from early binding "
               + "portgroup. Set property VMwareDVSPortSetting.blocked to true")
   public void test()
      throws Exception
   {
