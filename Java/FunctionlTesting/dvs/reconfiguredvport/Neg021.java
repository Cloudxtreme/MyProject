...
public class Neg021 extends CreateDVSTestBase
{
   ...
   {
      super.setTestDescription("Reconfigure DVPort with input list containing "
               + "two entries for the same port. Operations of these two "
               + "are edit and remove respectively");
   }
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  if (portKeyList != null && portKeyList.size() == DVS_PORT_NUM) {
                     ...
                     portConfigSpecs[1].setOperation(ConfigSpecOperation.EDIT.value());
                     status = true;
                  } else {
