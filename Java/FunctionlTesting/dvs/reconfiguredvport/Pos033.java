 ...
 */
public class Pos033 extends CreateDVSTestBase
{
   ...
   {
      super.setTestDescription("Reconfigure DVPort name with  alphabetical, "
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  if (portKeyList != null && portKeyList.size() == DVS_PORT_NUM) {
                     ...
                     portConfigSpecs[0].setName(DVSTestConstants.NAME_ALPHA_NUMERIC_SPECIAL_CHARS);
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Reconfigure DVPort name with  alphabetical, "
               + "numeric and " + "special characters.")
   public void test()
      throws Exception
   {
