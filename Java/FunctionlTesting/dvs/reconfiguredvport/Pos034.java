 ...
 */
public class Pos034 extends CreateDVSTestBase
{
   ...
   {
      super.setTestDescription("Reconfigure DVPort name with  NumericName");
   }
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  if (portKeyList != null && portKeyList.size() == DVS_PORT_NUM) {
                     ...
                     portConfigSpecs[0].setName(DVSTestConstants.ALL_NUM_STRING);
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Reconfigure DVPort name with  NumericName")
   public void test()
      throws Exception
   {
      log.info("Test Begin:");
