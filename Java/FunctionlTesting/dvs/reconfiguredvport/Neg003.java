...
public class Neg003 extends CreateDVSTestBase
{
   ...
   {
      super.setTestDescription("Reconfigure DVPort with an invalid MOR in "
               + "scope list");
   }
            ...
            if (this.networkFolderMor != null) {
               ...
               if (this.dvsMOR != null) {
                  ...
                  if (portKeyList != null && portKeyList.size() == DVS_PORT_NUM) {
                     ...
                     portConfigSpecs[0].getScope().addAll(com.vmware.vcqa.util.TestUtil.arrayToVector(new ManagedObjectReference[] { networkFolderMor }));
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Reconfigure DVPort with an invalid MOR in "
               + "scope list")
   public void test()
      throws Exception
   {
