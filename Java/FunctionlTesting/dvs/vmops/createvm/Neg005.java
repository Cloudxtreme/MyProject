...
/**
 * Create 2 VM's on a standalone host to connect to an unused DVPort in early
...
public class Neg005 extends VMopsBase
{
    ...
    * Create the earlyBinding portgroup,it has 1 unsued DVPort. 3. Create the
    * VMConfigSpec.
    *
    ...
    */
   @Override
   @Test(description = "Create 2 VM's on a standalone host to connect to an"
