 ...
 * earlyBinding DVPortgroup.The device is of type VirtualPCNet32. The backing is
 * of type DVPort backing and the port connection is a DVPortgroup connection.
 */
public class Pos009 extends VMopsBase
{
   /*
   ...
   public void setTestDescription()
   {
      setTestDescription("Create a VM on a Standalone host to connect to"
               + "existing DVPort on an earlyBinding DVPortgroup.The "
               + "device is of type VirtualPCNet32.");
   }
