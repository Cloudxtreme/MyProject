...
/**
 * Create 4 VM's on a standalone host to connect to an existing earlyBinding
 * DVPortgroup containing 4 unused ports.The device is of type VirtualPCNet32.
...
public class Pos017 extends VMopsBase
{
   ...
   {
      setTestDescription("Create 4 VM's on a Standalone host to connect to"
               + "an existing earlyBinding DVPortgroup containing 4 unused ports."
      ...
      throws Exception
   {
      ...
      if (super.testSetUp()) {
            ...
            if (hostNetworkConfig != null && hostNetworkConfig.length == 2) {
               ...
               if (networkUpdated) {
                  // Get the earlyBindig portgroupKey.
    ...
    */
   @Override
   @Test(description = "Create 4 VM's on a Standalone host to connect to"
               + "an existing earlyBinding DVPortgroup containing 4 unused ports."
               + "The device is of type VirtualPCNet32.")
   public void test()
      throws Exception
