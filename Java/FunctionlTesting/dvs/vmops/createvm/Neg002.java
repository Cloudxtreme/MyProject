 ...
 * Build DVPortConnection with invalid DVSwitchUuid. The device is of type
...
public class Neg002 extends VMopsBase
{
    ...
    * DVSwitchUuid. 4. Create the VMConfigSpec.
    *
   ...
   /**
    * Test. 1. Create the VM with invalid DVSwitchUuid.
    *
