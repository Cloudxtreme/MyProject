 ...
 * VirtualVMXNet2, the backing is of type DVPort backing and the port connection
 * is a DVPortgroup connection.
 */
public class Pos026 extends ReconfigureVMBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription(" Reconfigure a VM on a standalone host to connect"
               ...
               + "of type VirtualVMXNet2, the  backing is of type "
