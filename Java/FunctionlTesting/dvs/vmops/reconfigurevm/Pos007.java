 ...
 * DVPortgroup. The device is of type VirtualE1000, the backing is of type
 * DVPort backing and the port connection is a DVPortgroup connection.
 */
public class Pos007 extends ReconfigureVMBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription(" Reconfigure a VM on a standalone host to connect"
               + " to an existing early binding DVportgroup. The device is "
               + "of type VirtualE1000, the  backing is of type DVPort backing"
