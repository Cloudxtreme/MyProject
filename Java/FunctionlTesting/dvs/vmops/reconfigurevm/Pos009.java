 ...
 * earlyBinding DVPortgroup. The device is of type VirtualPCNet32, the backing
 * is of type DVPort backing and the port connection is a DVPortgroup
 * connection.
 */
public class Pos009 extends ReconfigureVMBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription(" Reconfigure a VM on a standalone host to connect"
               ...
               + "device is of type VirtualPCNet32, the  backing is of type "
