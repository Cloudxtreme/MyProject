 ...
 * DVPortgroupConfigSpec.NumPorts set to zero DVPortgroupConfigSpec.Type is set
 * to "early binding"
 */
public class Pos007 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a portgroup to an existing"
               + "distributed virtual switch with number of"
               + "ports set to zero");
   }
      ...
      log.info("Test setup Begin:");
         ...
         if (this.dcMor != null) {
            ...
            if (dvsMor != null) {
               ...
               this.dvPortgroupConfigSpec.setNumPorts(new Integer(0));
    ...
    * description set to a valid string, numPorts set to zero
    * 
    * @param connectAnchor ConnectAnchor object
    */
