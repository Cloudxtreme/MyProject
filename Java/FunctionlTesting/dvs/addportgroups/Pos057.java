...
/**
 * Add an early binding portgroup to the DVSwitch with an promiscuous pvlan id
 * in the default port config.
 */
public class Pos057 extends TestBase
{
   ...
   {
      setTestDescription("Add an early binding portgroup to the DVSwitch "
               + "with an promiscuous pvlan id in the default port"
               + " config.");
   }
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Add an early binding portgroup to the DVSwitch "
               + "with an promiscuous pvlan id in the default port"
               + " config.")
   public void test()
      throws Exception
