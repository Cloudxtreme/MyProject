...
/**
 * DESCRIPTION:Create a portgroup with a newly created nrp associated to it <BR>
 * TARGET: VC <BR>
 * SETUP:<BR>
 * 1. Create a vDS <BR>
 * 3. Enable netiorm <BR>
 ...
 */
public class Pos081 extends TestBase
{
    ...
    * Test method
    */
   @Test(description = "Create a portgroup with a newly created nrp associated to it")
   public void test()
      throws Exception
   {
   ...
   {
      setTestDescription("Create a portgroup with a newly created nrp associated to it");
   }
