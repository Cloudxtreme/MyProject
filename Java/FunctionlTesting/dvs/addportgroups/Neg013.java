 ...
 * scope set to a folder Mor and reconfigure a VM on the host to connect its
 * VNIC to this portgroup
 */
public class Neg013 extends TestBase
{
      ...
      throws Exception
   {
      ...
      folderMor = iFolder.createFolder(rootFolderMor, getTestId() + "-Folder");
      ...
      if (dvsMor != null) {
         ...
         if (vmMor != null) {
            ...
            if (iVirtualMachine.setVMState(vmMor, VirtualMachinePowerState.POWERED_OFF, false)) {
               ...
               dvPortgroupConfigSpec.getScope().addAll(com.vmware.vcqa.util.TestUtil.arrayToVector(new ManagedObjectReference[] { folderMor }));
               status = true;
            }
         } else {
   ...
   /**
    * Method that adds an early binding portgroup with scope set to a folder MOR
    * and reconfigures a VM-vnic to connect to this portgroup
    *
    * @param connectAnchor ConnectAnchor object
    */
   @Override
      ...
      throws Exception
   {
      ...
      try {
          ...
          */
         status &= iFolder.destroy(folderMor);
         /*
