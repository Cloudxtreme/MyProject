 ...
 * scope set to a resource pool MOR and reconfigure the VM in the resource pool
 * to connect its VNIC to this portgroup
 */
public class Pos013 extends TestBase
{
               ...
               if (dvsMor != null) {
                  ...
                  if (this.vmMor != null) {
                     ...
                     if (this.iVirtualMachine.setVMState(vmMor, VirtualMachinePowerState.POWERED_OFF, false)) {
                        ...
                        this.dvPortgroupConfigSpec.getScope().addAll(com.vmware.vcqa.util.TestUtil.arrayToVector(new ManagedObjectReference[] { vmMor }));
                        status = true;
                     }
                  } else {
   ...
   /**
    * Method that adds an early binding portgroup with scope set to a virtual
    * machine MOR and reconfigures a VM-vnic to connect to this portgroup
    * 
    * @param connectAnchor ConnectAnchor object
    */
            ...
            if (dvPortgroupMorList != null) {
               if (dvPortgroupMorList.size() == dvPortgroupConfigSpecArray.length) {
                  ...
                  if (portgroupKey != null) {
                     ...
                     if (this.iDVSwitch.getHostMemberConnectedToDVSwitch(
                              dvsMor, hostMor) != null) {
                        log.info("$$$$$$$$Host successfully connected to DVS");
                     } else {
                        log.error("*****Host not connected to DVS");
                     }
