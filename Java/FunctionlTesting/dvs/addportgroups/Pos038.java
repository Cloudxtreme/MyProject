...
/**
 * Add a portgroup to an existing distributed virtual switch with macChanges set
 * to false
 */
public class Pos038 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a portgroup to an existing"
               + "distributed virtual switch with macChanges " + "set to false");
   }
      ...
      throws Exception
   {
      ...
      if (dcMor != null) {
         ...
         if (dvsMor != null) {
            ...
            secPolicy = DVSUtil.getDVSSecurityPolicy(false, null, false, null);
