 ...
 * DVPortgroupConfigSpec.PortSetting.Vlan set to 4094
 */
public class Pos072 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a portgroup to an existing distributed virtual "
               + "switch with the vlan id set to 4094 in the default "
               + "port setting");
   }
      ...
      NumericRange[] vlanIds = null;
         ...
         if (this.dcMor != null) {
            ...
            if (dvsMor != null) {
               ...
               vlanIds = new NumericRange[2];
               vlanIds[0] = new NumericRange();
               vlanIds[0].setStart(30);
               vlanIds[0].setEnd(45);
               vlanIds[1] = new NumericRange();
               vlanIds[1].setStart(70);
               vlanIds[1].setEnd(80);
               vlanIDSpec.getVlanId().clear();
               vlanIDSpec.getVlanId().addAll(com.vmware.vcqa.util.TestUtil.arrayToVector(vlanIds));
