 ...
 * a promiscous pval id in the default port config, and pg2 having a community
...
public class Pos051 extends TestBase
{
   ...
   private static final int COMMUNIITY_PVLAN_ID = 20;
   ...
   public void setTestDescription()
   {
      setTestDescription("Add two early binding portgroups pg1, and pg2 to "
               + "the DVSwitch with pg1 having a promiscous pval id "
               + "in the default port config, and pg2 having a "
                  ...
                  if (this.hostNetworkConfig != null
                     ...
                     if (this.ins.updateNetworkConfig(this.nwSystemMor,
                        ...
                        if (this.iDVSwitch.addSecondaryPvlan(this.dvsMor,
                                 ...
                                 PROMISCUOUS_PVLAN_ID, COMMUNIITY_PVLAN_ID,
                                 true)) {
                           ...
                           portgroupConfigSpec.setType(DVSTestConstants.DVPORTGROUP_TYPE_EARLY_BINDING);
                           pvlanSpec = new VmwareDistributedVirtualSwitchPvlanSpec();
                           pvlanSpec.setPvlanId(COMMUNIITY_PVLAN_ID);
                           settingsMap.put(DVSTestConstants.VLAN_KEY, pvlanSpec);
                           portSetting = DVSUtil.getDefaultVMwareDVSPortSetting(settingsMap);
                           portgroupConfigSpec.setDefaultPortConfig(portSetting);
                           this.dvPortgroupConfigSpec.add(portgroupConfigSpec);
