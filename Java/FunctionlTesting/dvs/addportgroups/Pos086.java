...
/**
 * DESCRIPTION:<br>
 *  Data-driven test to add PortGroup to a DistributedVirtualSwitch with
 * IpfixEnabled parameter set to true/false in VMPortConfigPolicy <br>
 * SETUP:<br>
 * 1. Create a DVS by adding a host to VC.<br>
 * 2. Create dvPortgroupConfigSpec object with IpfixEnabled parameter set <br>
 * TEST:<br>
...
public class Pos086 extends TestBase implements IDataDrivenTest
{
   ...
   private com.vmware.vcqa.vim.DistributedVirtualPortgroup dvpg = null;
   ...
   @Test(description = "Add PortGroup to a DistributedVirtualSwitch with IpfixEnabled " +
   		"parameter set to true in VMPortConfigPolicy.")
   public void test()
      throws Exception
   {
      ManagedObjectReference dvPortgroupMor = null;
      Assert.assertNotNull(dvPortgroupConfigSpec, "Could not add all the portgroups");
