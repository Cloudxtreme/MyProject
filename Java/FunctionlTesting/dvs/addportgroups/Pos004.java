 ...
 * DVPortgroupConfigSpec.Name is set to a valid string of 31 characters
 */
public class Pos004 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a portgroup to an existing"
               ...
               + " of 31 characters and "
               + "add vendorSpecificConfig (PR#383759");
   }
      ...
      throws Exception
   {
      ...
      log.info("Test setup Begin:");
         ...
         this.iDataProvider = I18NFactoryImpl.getITestDataProviderImpl();
         ...
         if (this.dcMor != null) {
            ...
            this.dvsConfigSpec.setName(iDataProvider.getData(
            ...
            if (dvsMor != null) {
               ...
               this.dvPortgroupConfigSpec.setName(iDataProvider.getData(I18NResourceKeyConstants.DVS_VALID_DVPORTGROUP_NAME_31_CHARS));
               /*
                * Set vendorSpecificConfig
                */
               ...
               portSetting = DVSUtil.getDefaultPortSetting(settingsMap, null);
