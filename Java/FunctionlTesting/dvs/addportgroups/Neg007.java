...
/**
 * Add a portgroup with an invalid "numPorts" which is greater than the maximum
 * number of ports in the dvswitch
 */
public class Neg007 extends TestBase
{
   ...
   {
      setTestDescription("Add a portgroup with an invalid numPorts which is"
               + "greater than the maximum number of ports in the dvswitch");
   }
      ...
      log.info("Test setup Begin:");
         ...
         if (this.dcMor != null) {
            ...
            if (dvsMor != null) {
               ...
               this.dvPortgroupConfigSpec.setName(this.getTestId() + "-1");
               this.dvPortgroupConfigSpec.setDescription(DVSTestConstants.DVPORTGROUP_VALID_DESCRIPTION);
               this.dvPortgroupConfigSpec.setNumPorts(25);
   ...
   /**
    * Method that adds a portgroup with an invalid number of ports which is
    * greater than the maximum number of ports in the dvswitch
    * 
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Add a portgroup with an invalid numPorts which is"
               + "greater than the maximum number of ports in the dvswitch")
   public void test()
      throws Exception
   {
      ...
      try {
         ...
         MethodFault expectedMethodFault = new LimitExceeded();
