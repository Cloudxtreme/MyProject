 ...
 * DVPortgroupConfigSpec.Name is set to string that is a single character.
 */
public class Pos067 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a portgroup to an existing distributed virtual "
               + "switch with a name that is a single character");
   }
      ...
      log.info("Test setup Begin:");
         ...
         if (this.dcMor != null) {
            ...
            if (dvsMor != null) {
               ...
               this.dvPortgroupConfigSpec.setName("a");
