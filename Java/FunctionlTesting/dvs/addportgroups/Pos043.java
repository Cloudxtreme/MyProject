 ...
 * portConfigResetAtDisconnect set to true and settingBlockOverrideAllowed set
 * to true
 */
            ...
            if (portgroupKey != null) {
               if (this.iDVSwitch.movePort(dvsMor, new String[] { portKey },
                  ...
                  if (this.iVirtualMachine.reconfigVM(vmMor,
                     ...
                     this.iDVSwitch.refreshPortState(this.dvsMor,
                              new String[] { this.portKey });
                     ...
                     if (dvPorts != null && dvPorts.get(0) != null) {
                        ...
                        if (dvPorts.get(0).getConfig().getSetting().getBlocked().isInherited() == true
                                 || dvPorts.get(0).getConfig().getSetting().getBlocked().isValue() == true) {
