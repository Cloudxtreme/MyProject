 ...
 * an promiscuous pvlan id in the default port config and pg2 having a isolated
...
public class Pos052 extends TestBase
{
   ...
   private static final int ISOLATED_PVLAN_ID = 20;
   ...
   public void setTestDescription()
   {
      setTestDescription("Add two early binding portgroups pg1, and pg2 to"
               + " the DVSwitch with pg1 having an promiscuous pvlan"
                  ...
                  if (this.hostNetworkConfig != null
                     ...
                     if (this.ins.updateNetworkConfig(this.nwSystemMor,
                        ...
                        if (this.iDVSwitch.addSecondaryPvlan(this.dvsMor,
                           ...
                           pvlanSpec.setPvlanId(PROMISCUOUS_PVLAN_ID);
