...
import static com.vmware.vcqa.TestConstants.TESTINPUT_PASSWORD;
import static com.vmware.vcqa.TestConstants.TESTINPUT_USERNAME;
...
public class LagTest extends TestBase implements IDataDrivenTest
{

   private Object     lagTestFramework = null;
   ...
   public void test() throws Exception
   {
      ...
      try {
         Method method = testFrameworkClass.getDeclaredMethod("execute",
               List.class);
         method.invoke(this.lagTestFramework, stepList);
   ...
   public void initializeTest() throws Exception
   {
      if (DVSUtil.getvDsVersion().compareTo(DVSTestConstants.VDS_VERSION_55) < 0) {
          log.error("cannot execute multi lag test cases prior to " +
              "dvs version 5.5.0");
          throw new Exception("cannot execute multi lag test cases prior to " +
              "dvs version 5.5.0");
      }
      ...
      lagTestFramework = constructor.newInstance(this.connectAnchor,
            beanPath);
   }
   ...
   public boolean testSetUp() throws Exception
   {
      ...
      /*
       * Set login user and password for security cases
       */
      String user = super.data.getString(TESTINPUT_USERNAME);
      String passwd = super.data.getString(TESTINPUT_PASSWORD);
      Method method1 = testFrameworkClass.getDeclaredMethod("setUserPassed",
            String.class, String.class);
      method1.invoke(this.lagTestFramework, user, passwd);
      /*
