...
/**
 * This is a generic test class for all the negative tests in fetchOpaqueData
 * api
 *
 * @author sabesanp
 *
 */
public class FetchOpaqueDataNegTest extends TestBase implements IDataDrivenTest
{
    ...
    * @throws Exception
    */
   @Test(description="Set of all fetchopaquedata negative tests")
   public void test()
      throws Exception
   {
