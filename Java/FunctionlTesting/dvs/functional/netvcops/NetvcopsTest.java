package dvs.functional.netvcops;
...
public class NetvcopsTest extends TestBase implements IDataDrivenTest
{

   private Object NetvcopsTestFramework = null;
    ...
    */
   @Override
   @Test(description="Set of all tests for NetVCOps api")
   public void test()
      throws Exception
   {
      ...
      try {
         ...
         method.invoke(this.NetvcopsTestFramework, stepList);
      ...
      throws Exception
   {
      if (DVSUtil.getvDsVersion().compareTo(DVSTestConstants.VDS_VERSION_55) < 0) {
          log.error("cannot execute netvcops enhancement test " +
                              "cases prior to dvs version 5.5.0");
          throw new Exception("cannot execute netvcops enhancement test " +
                              "cases prior to dvs version 5.5.0");
      }
