 ...
 * 4. Destroy vDs<br>
 */
public class Pos023 extends TestBase implements IDataDrivenTest  
{
   /*
      ...
      throws Exception
   {
      ...
      this.dcMor =
               folder.createDatacenter(this.folder.getRootFolder(), this
                        .getTestId()
                        + "_DC");
      /*
       ...
       */
      hostContainer = DVSUtil.createHostContainer(dcMor, true);
      hostContainerFilter =
   ...
   {
      if (dcMor != null) {
         assertTrue(this.folder.destroy(dcMor), " Unable to delete DVS");
      }
      return true;
   }
