 ...
 * to connect to an late binding portgroup.
 */
public class Neg013 extends FunctionalTestBase
{
               ...
               if (this.vmMor != null) {
                  ...
                  if (status) {
                     ...
                     if (vdConfigSpec != null && vdConfigSpec.size() > 0) {
                        ...
                        if (pgKey != null) {
                           log.info("Successfully Created the late "
                                    + "binding portgroup");
                           ...
                           status = false;
                           log.error("Can not add the late binding "
   ...
   @Test(description = "Disconnect the host(H1) from the VC, Using hostd "
               + " reconfigure a powered on  VM  to connect to an late  "
               + "binding portgroup.")
   public void test()
      throws Exception
   {
