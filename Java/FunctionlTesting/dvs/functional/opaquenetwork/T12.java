...
public class T12 extends TestBase{
        ...
        public void test() throws Exception {
                 ...
                 * Suspend the vm
                 */
                assertTrue(vm.setVMState(vmMor, VirtualMachinePowerState.SUSPENDED,
                                true),"Successfully suspended the virtual machine",
                ...
                assertTrue(vm.setVMState(vmMor, VirtualMachinePowerState.POWERED_OFF,
                                true),"Successfully powered off the virtual machine",
