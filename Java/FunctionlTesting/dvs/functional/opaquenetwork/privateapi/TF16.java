...
public class TF16 extends PrivateApiBase
{
      ...
      throws Exception
   {
      ...
      VirtualMachineConfigSpec vmConfigSpec = DVSUtil.
         ...
         */
         ...
         assertTrue(vEthernetDevice.getExternalId().equals(
                                                "vm-external-id"),
                                                "vm created with external id",
      ...
      throws Exception
   {
        ...
        vEthernetDevice.setExternalId(null);
        ...
        vm.reconfigVM(vmMor, vmConfigSpec);
         ...
         assertTrue(vEthernetDevice.getExternalId() == null, "vm external id removed",
                 "vm external id updation error " + vEthernetDevice.getExternalId());
   }
   @AfterMethod
