package dvs.functional.netiocv3;
...
public class NetIoCV3Test extends TestBase implements IDataDrivenTest
{

   private Object netIocV3TestFramework = null;
    ...
    * @throws Exception
    */
   @Test(description="Set of all tests for Network IO control v3 api")
   public void test()
      throws Exception
   {
      ...
      try{
         Method method = testFrameworkClass.getDeclaredMethod("execute",
                  List.class);
         method.invoke(this.netIocV3TestFramework, stepList);
      ...
      throws Exception
   {
      ...
      netIocV3TestFramework = constructor.newInstance(this.connectAnchor,
         beanPath);
   }
