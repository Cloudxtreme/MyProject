 ...
 * connected to a port on a late binding port on the DVS and the port is
 * occupied, and there is a free port in the porgroup for the VM ethernet
 * adapter to connect while reverting the snapshot.
 */
public class Pos006 extends VMSFunctionalTestBase
{
   /**
   ...
   public void setTestDescription()
   {
      setTestDescription("Revert a powered on VM to a snapshot when it's VM "
               ...
               + " binding port on the DVS and the port is "
