 ...
 * earlyBinding DVPortgroup on an existing DVSwitch. The DVPort is of type
...
public class Pos003 extends VNicBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a service console vnic to connect to an "
               + "existing DVPort on an earlyBinding DVPortgroup on an "
               + "existing DVSwitch. The DVPort is of type DistributedVirtualSwitchPortConnection.");
   }

   /**
    * Method to setup the environment for the test. 1. Create the DVSwitch by
    * using hostMor. 2. Create the earlyBinding DVPortgroup. 3. Create
