...
/**
 * Add a service console vnic to connect to an existing lateBinding DVPortgroup
 * on an existing DVSwitch. Build the DVPortConnection with invalid lateBinding
 * DVPortgroupKey and DVPort as null. The distributedVirtualPort is of type
...
public class Neg006 extends VNicBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a service console vnic to connect to an "
               ...
               + "DVPortConnection with invalid earlyBinding DVPortgroupKey."
      ...
      throws Exception
   {
      ...
      try {
         ...
         scVNicId = ins.addServiceConsoleVirtualNic(nwSystemMor, "",
                  hostVNicSpec);
         if (scVNicId != null) {
            log.info("Successfully add the service console Virtual NIC."
