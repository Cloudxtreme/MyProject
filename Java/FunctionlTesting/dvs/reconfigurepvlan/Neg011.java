...
/**
 * Add a PVLAN map entry to DVS by providing different primary and secondary IDs
 * with type as promiscuous. P1(10,101,P)
 */
public class Neg011 extends PvlanBase
{
   /**
   ...
   {
      setTestDescription("Add a PVLAN map entry to DVS by providing different "
               + "primary and secondary IDs with type as promiscuous.");
   }
    ...
    */
   @Override
   @Test(description = "Add a PVLAN map entry to DVS by providing different "
               + "primary and secondary IDs with type as promiscuous.")
   public void test()
      throws Exception
   {
      ...
      try {
         iVmwareDVS.addPvlan(dvsMor, PVLAN_TYPE_PROMISCUOUS, PVLAN1_PRI_1,
                  PVLAN1_SEC_1);
