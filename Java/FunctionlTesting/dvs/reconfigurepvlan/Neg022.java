...
/**
 * Add a PVLAN map entry to the DVS with primary ID as 1 and secondary ID as 0
 * with port type as isolated.
 */
public class Neg022 extends PvlanBase
{
   /**
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a PVLAN map entry to the DVS with primary ID "
               + "as 1 and secondary ID as 0 with port type as isolated.");
   }
      ...
      throws Exception
   {
      ...
      try {
         iVmwareDVS.addPvlan(dvsMor, PVLAN_TYPE_ISOLATED, MIN_PVLAN_ID, 0);
