...
/**
 * Add a PVLAN map entry to DVS by providing valid MOR but invalid primary VLAN
 * ID.
 */
public class Neg006 extends PvlanBase
{
   /**
      ...
      throws Exception
   {
      ...
      try {
         iVmwareDVS.addPvlan(dvsMor, PVLAN_TYPE_PROMISCUOUS, -1, PVLAN1_PRI_1);
