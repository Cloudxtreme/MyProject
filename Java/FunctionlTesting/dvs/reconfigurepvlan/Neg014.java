...
/**
 * Add a PVLAN map entry to the DVS with secondary ID which is same as existing
 * primary ID. P1(10,10,P), P2(20,10,C)
 */
public class Neg014 extends PvlanBase
{
   /**
   ...
   {
      setTestDescription("Add a PVLAN map entry to the DVS with secondary ID "
               + "which is same as existing primary ID. "
               + "P1(10,10,P) , P1(20,10,C).");
   }
      ...
      throws Exception
   {
      boolean status = false;
         ...
         if (super.testSetUp()) {
            ...
            if (dvsMor != null) {
               status = iVmwareDVS.addPrimaryPvlan(dvsMor, PVLAN1_PRI_1);
            }
         }
    ...
    */
   @Override
   @Test(description = "Add a PVLAN map entry to the DVS with secondary ID "
               + "which is same as existing primary ID. "
               + "P1(10,10,P) , P1(20,10,C).")
   public void test()
      throws Exception
   {
      ...
      try {
         iVmwareDVS.addSecondaryPvlan(dvsMor, PVLAN_TYPE_COMMINITY,
                  PVLAN2_PRI_1, PVLAN1_PRI_1, true);
