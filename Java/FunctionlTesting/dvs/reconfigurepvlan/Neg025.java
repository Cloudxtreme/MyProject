...
/**
 * Add a PVLAN map entry to the DVS with primary ID as 1 and secondary ID as
 * 4095 with port type as community.
 */
public class Neg025 extends PvlanBase
{
   /**
   ...
   public void setTestDescription()
   {
      setTestDescription("Add a PVLAN map entry to the DVS with primary ID "
               + "as 1 and secondary ID as 4095 with port type as community.");
   }
      ...
      throws Exception
   {
      ...
      try {
         iVmwareDVS.addPvlan(dvsMor, PVLAN_TYPE_COMMINITY, 1, MAX_PVLAN_ID + 1);
