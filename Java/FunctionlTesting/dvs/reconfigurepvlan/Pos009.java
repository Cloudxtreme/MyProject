 ...
 * promiscuous port and other secondary VLAN with community port. P1-(10)
 * P2-(101) Procedure:<br>
 ...
 * 5. The DVPorts belonging to primary and secondary PVLAN should have
 * connectivity.<br>
 * Cleanup:<br>
 ...
 */
public class Pos009 extends PvlanBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription(" Add a PVLAN map entry to DVS by providing"
               + " a secondary VLAN with port type as community."
               + "Reconfigure two DVPorts to use these VLAN IDs.");
   }
