...
/**
 * Add a PVLAN map entry to DVS by providing a secondary VLAN ID with port type
 * as isolated. Reconfigure two DVPorts to use isolated PVLAN ID. P1(101),
 * P2(101) Procedure:<br>
 ...
 * 5. The DVPorts belonging to same secondary PVLAN of type isolated should not
 ...
 */
public class Pos006 extends PvlanBase
{
