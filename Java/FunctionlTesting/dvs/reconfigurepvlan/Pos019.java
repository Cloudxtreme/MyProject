...
public class Pos019 extends PvlanBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Remove a PVLAN map entry in DVS by providing valid "
               + "secondary PVLAN ID and type being community.");
   }
      ...
      throws Exception
   {
      boolean status = false;
         ...
         if (iVmwareDVS.removePvlan(dvsMor, PVLAN_TYPE_COMMINITY, PVLAN1_PRI_1,
                  PVLAN1_SEC_1, false)) {
