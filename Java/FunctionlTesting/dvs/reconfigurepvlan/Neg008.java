...
/**
 * Add a PVLAN map entry to DVS by providing valid MOR but invalid secondary
 * VLAN ID.
 */
public class Neg008 extends PvlanBase
{
   /**
   ...
   {
      setTestDescription("Add a PVLAN map entry to DVS by providing valid "
               + "MOR but invalid secondary VLAN ID.");
   }
      ...
      throws Exception
   {
      ...
      try {
         iVmwareDVS.addPvlan(dvsMor, PVLAN_TYPE_PROMISCUOUS, PVLAN1_PRI_1, -101);
