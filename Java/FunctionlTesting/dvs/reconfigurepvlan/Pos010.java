...
/**
 * Add two PVLAN map entries to the DVS by providing one primary VLAN with
 * promiscuous port and other secondary VLAN with isolated port. P1-(10,P)
 * P2-(101,I) Procedure:<br>
 ...
 * Test:<br>
 * 4. Add a secondary PVLAN map entry of type isolated to DVS. <br>
 * 5. The DVPort belonging to isolated PVLAN and the same primary PVLAN should
 ...
 */
public class Pos010 extends PvlanBase
{
      ...
      throws Exception
   {
      ...
      log.info("Test Begin:");
         ...
         if (iVmwareDVS.addSecondaryPvlan(dvsMor, PVLAN_TYPE_ISOLATED,
            ...
            status = areConnected(connectAnchor, PVLAN1_PRI_1, PVLAN1_SEC_1,
                     vm1Mor, vm2Mor);
         }
