...
/**
 * Remove a PVLAN map entry by providing empty DVS MOR.
 */
public class Neg029 extends PvlanBase
{
   /**
   ...
   {
      setTestDescription("Remove a PVLAN map entry by providing empty DVS MOR.");
   }
    ...
    */
   @Override
   @Test(description = "Remove a PVLAN map entry by providing empty DVS MOR.")
   public void test()
      throws Exception
   {
      boolean status = false;
      ...
      try {
         iVmwareDVS.removePvlan(new ManagedObjectReference(),
                  PVLAN_TYPE_PROMISCUOUS, PVLAN1_PRI_1, PVLAN1_SEC_1, false);
