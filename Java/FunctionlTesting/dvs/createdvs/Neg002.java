...
/**
 * Create a DVS with network Folder set as empty MOR
 */
public class Neg002 extends CreateDVSTestBase
{
   ...
   {
      super.setTestDescription("Create a DVS with an empty MOR");
   }
    ...
    * @param connectAnchor ConnectAnchor object
    */
   @Test(description = "Create a DVS with an empty MOR")
   public void test()
      throws Exception
   {
      log.info("Test Begin:");
