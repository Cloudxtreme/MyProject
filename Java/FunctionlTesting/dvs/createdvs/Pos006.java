 ...
 * DVSConfigSpec.description is set to "Create DVS- Pos006 description"
 */
public class Pos006 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create a DVSwitch inside a valid folder with"
               ...
               + "empty string,\n" + "2.DVSConfigSpec.description is set to "
               + "'Create DVS- Pos006 description'");
   }
      ...
      throws Exception
   {
      ...
      String dvsDescription = this.getTestDescription();
      log.info("Test setup Begin:");
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               this.configSpec.setDescription(dvsDescription);
               status = true;
            } else {
