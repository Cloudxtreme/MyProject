 ...
 * DVSConfigSpec.name is set to "CreateDVS-Neg037" - DVPortSetting.blocked is
 * set to false - inShapingPolicy.enabled is set to true -
 * inShapingPolicy.averageBandWidth is set to -1.
 */
public class Neg037 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create a DVS inside a valid folder with the"
               ...
               + "  - DVSConfigSpec.name is set to 'CreateDVS-Neg037'\n"
               + "  - DVPortSetting.blocked is set to false\n"
               + "  - inShapingPolicy.enabled is set to true\n"
               + "  - inShapingPolicy.averageBandWidth is set to -1.");
   }
