 ...
 * string. - DVSConfigSpec.name is set to "CreateDVS-Neg019" -
 ...
 * valid array that has number of elements more than the number of pnics being
 ...
 * to a valid number less than the num of uplinks ports per host
 */
public class Neg019 extends CreateDVSTestBase
{
   /*
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create DVSwitch with the following parameters"
               ...
               + "- DVSConfigSpec.name is set to 'CreateDVS-Neg019',\n"
               ...
               + "less than the num of uplinks ports per host.");
   }
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (physicalNics != null) {
                  ...
                  uplinkPortNames = new String[physicalNics.length + 5];
                  for (int i = 0; i < physicalNics.length + 5; i++) {
                     uplinkPortNames[i] = "uplink" + i;
                  }
                  this.configSpec.setMaxPorts(2);
