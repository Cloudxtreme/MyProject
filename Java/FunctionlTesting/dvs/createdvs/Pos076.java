 ...
 *
 */
public class Pos076 extends TestBase implements IDataDrivenTest
{
   ...
   /**
    * This method sets the environment for the test
    *
    * @return boolean, true if the setup is successful
    *                  false otherwise
    *
    * @throws Exception
    */
      ...
      throws Exception
   {
      ...
      */
      ...
      linkDiscoveryProtocolConfig.setProtocol(this.data.
         getString(DVSTestConstants.LLDP_PROTOCOL));
      vdsConfigSpec.setLinkDiscoveryProtocolConfig(linkDiscoveryProtocolConfig);
      return true;
   }

   /**
    * This method creates the vds with lldp parameters and verifies
    * that the parameters were set as expected
    *
    * @throws Exception
    */
   @Test(description="Data driven test to handle all positive test " +
      "cases for lldp parameters in create vds api")
   public void test()
      throws Exception
   {
      /*
      ...
      assertTrue(DVSUtil.verifyLldpInfo(this.connectAnchor, this.hostMor,
         this.vdsMor, this.linkDiscoveryProtocolConfig),"The expected " +
            "and actual lldp parameters match","The expected and " +
               "actual lldp parameters do not match");
   }

   /**
    * This method destroys the created vds
    *
