 ...
 * string. - DVSConfigSpec.name is set to "CreateDVS-Pos025" -
 * DVSConfigSpec.maxPort set to a valid number more than the numPorts -
 * DVSConfigSpec.numPort set to a valid number more than the number of uplinks
 * ports per host - DVSConfigSpec.uplinkPortPolicy set to a valid array that has
 ...
 * to a valid number equal to numPorts
 */
public class Pos025 extends CreateDVSTestBase
{
   /*
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create DVSwitch with the following parameters"
               ...
               + "- DVSConfigSpec.name is set to 'CreateDVS-Pos025',\n"
               + "- DVSConfigSpec.maxPort set to a valid number more than the numPorts\n"
               ...
               + "of elements more than the number of pnics being added."
               + "({uplink1, .. uplinkn}),\n"
               + "- DistributedVirtualSwitchHostMemberConfigSpec.operation set to add\n"
               + "- DistributedVirtualSwitchHostMemberConfigSpec.host set to a valid host Mor\n"
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (physicalNics != null) {
                  ...
                  this.configSpec.setMaxPorts(2 * uplinkPortNames.length + 6);
            ...
            if (this.dvsMOR != null) {
               ...
               if (iDistributedVirtualSwitch.validateDVSConfigSpec(this.dvsMOR,
                  ...
                  if (DVSUtil.checkNetworkConnectivity(
                           this.ihs.getIPAddress(this.hostMor), null)) {
