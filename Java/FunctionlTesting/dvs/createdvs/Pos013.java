 ...
 * DVSConfigSpec.name is set to "CreateDVS-Pos013"
 * DVSConfigSpec.DVSContactInfo.name is set to 'Contact CreateDVS-Pos013'
 */
public class Pos013 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create a DVSwitch inside a valid folder with"
               ...
               + "'CreateDVS-Pos013',\n"
               + "3.DVSConfigSpec.DVSContactInfo.name is set"
               + " to'Contact CreateDVS-Pos013'");
   }
