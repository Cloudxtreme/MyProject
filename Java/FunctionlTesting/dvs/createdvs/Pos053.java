 ...
 * configVersion - empty string name - "Create DVS-Pos053" numPort - valid
 * number maxPort - valid number For DVPortSetting: blocked - false vlan[] - a
 * valid array containing valid vlan id range
 */

public class Pos053 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create a DVSwitch inside a valid folder with"
               ...
               + "name - 'Create DVS-Pos053'\n " + "numPort - valid number\n"
               + "maxPort - valid number\n" + "For DVPortSetting:\n"
               + "blocked - false\n"
               + "vlan[] - a valid array containing valid vlan id range");
   }
      ...
      log.info("Test setup Begin:");
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               vlanIdRange.setStart(200);
               vlanIdRange.setEnd(500);
