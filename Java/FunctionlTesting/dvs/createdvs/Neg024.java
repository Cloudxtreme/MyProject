 ...
 * DVSConfigSpec.name is set to "CreateDVS-Neg024" -
 ...
 * proxy selection that has a multiple PnicSpecs having one invalid pnic key.
 */
public class Neg024 extends CreateDVSTestBase
{
      ...
      log.info("Test setup Begin:");
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               pnicSpec = new DistributedVirtualSwitchHostMemberPnicSpec[4];
      ...
      throws Exception
   {
      ...
      try {
         ...
         MethodFault expectedMethodFault = new DvsOperationBulkFault();
