 ...
 * string. - DVSConfigSpec.name is set to "CreateDVS-Pos018" -
 * DVSConfigSpec.uplinkPortPolicy set to an array with valid number of elements
 * {uplink1...uplinkn} - DistributedVirtualSwitchHostMemberConfigSpec.operation
 * set to add - DistributedVirtualSwitchHostMemberConfigSpec.host set to a valid
 * host Mor - DistributedVirtualSwitchHostMemberConfigSpec.proxy set a a valid
 * pnic proxy selection with pnic spec having a valid pnic device and
 * uplinkPortKey set to null
 */
public class Pos018 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create DVSwitch with the following parameters"
               ...
               + "- DVSConfigSpec.name is set to 'CreateDVS-Pos018',\n"
               + "- DVSConfigSpec.uplinkPortPolicy set to an array with valid number of "
               + "elements {uplink1...uplinkn},\n"
