 ...
 * string. - DVSConfigSpec.name is set to "CreateDVS-Pos023" -
 * DVSConfigSpec.maxPort set to a valid number that is more than the numPorts -
...
public class Pos023 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create DVSwitch with the following parameters"
               ...
               + "- DVSConfigSpec.name is set to 'CreateDVS-Pos023',\n"
               + "- DVSConfigSpec.maxPort set to a valid number that is more than the"
               + " numPorts,\n"
