 ...
 * DVSConfigSpec.name is set to "CreateDVS-Neg022" -
 * DistributedVirtualSwitchHostMemberConfigSpec.operation set to add -
 * DistributedVirtualSwitchHostMemberConfigSpec.host set to an empty Mor -
 * DistributedVirtualSwitchHostMemberConfigSpec.proxy set a valid pnic proxy
 * selection
 */
public class Neg022 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create a DVS inside a valid folder with the "
               ...
               + "- DistributedVirtualSwitchHostMemberConfigSpec.operation set to add\n"
               + "- DistributedVirtualSwitchHostMemberConfigSpec.host set to an empty Mor\n"
               + "- DistributedVirtualSwitchHostMemberConfigSpec.proxy set a valid pnic proxy selection\n");
   }
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               if (physicalNics != null) {
                  ...
                  hostConfigSpecElement.setHost(new ManagedObjectReference());
