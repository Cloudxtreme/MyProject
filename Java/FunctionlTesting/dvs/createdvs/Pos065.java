 ...
 * DVSConfigSpec.name is set to A string containing all numeric characters.
 */
public class Pos065 extends CreateDVSTestBase
{
   /**
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create a DVSwitch inside a valid nested "
               ...
               + "containing all numeric characters");
   }
      ...
      log.info("Test setup Begin:");
         ...
         if (super.testSetUp()) {
            ...
            if (this.networkFolderMor != null) {
               ...
               this.configSpec.setName(DVSTestConstants.ALL_NUM_STRING);
               status = true;
            } else {
