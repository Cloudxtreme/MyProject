 ...
 * DVSConfigSpec.name is set to "CreateDVS-Neg036" - DVPortSetting.blocked is
 * set to false - inShapingPolicy.enabled is set to true -
 * inShapingPolicy.peakBandWidth is set to -1.
 */
public class Neg036 extends CreateDVSTestBase
{
   ...
   public void setTestDescription()
   {
      super.setTestDescription("Create a DVS inside a valid folder with the"
               ...
               + "  - DVSConfigSpec.name is set to 'CreateDVS-Neg036'\n"
