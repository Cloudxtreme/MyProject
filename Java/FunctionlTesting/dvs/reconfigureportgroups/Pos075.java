...
public class Pos075 extends TestBase implements IDataDrivenTest
{
   ...
   @Test(description="Reconfigure PortGroup to a DistributedVirtualSwitch with " +
   		"IpfixEnabled parameter set to true/false in VMPortConfigPolicy and " +
   		"inherited set to true/false")
   public void test()
      throws Exception
   {
