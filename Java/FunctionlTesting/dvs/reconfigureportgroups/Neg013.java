 ...
 * switch with scope set to a host Mor and reconfigure a VM on the host to
...
public class Neg013 extends TestBase
{
    ...
    * host MOR and reconfigures a VM-vnic to connect to this portgroup
    * 
    * @param connectAnchor ConnectAnchor object
    */
      ...
      throws Exception
   {
      ...
      try {
         ...
         this.dvPortgroupConfigSpec.getScope().addAll(com.vmware.vcqa.util.TestUtil.arrayToVector(new ManagedObjectReference[] { this.hostMor }));
