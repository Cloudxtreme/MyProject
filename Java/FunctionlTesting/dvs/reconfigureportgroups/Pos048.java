 ...
 * switch with settingSecurityPolicyOverrideAllowed set to true
 */
public class Pos048 extends TestBase
{
            ...
            if (dvsMor != null) {
               ...
               if (dvPorts != null && dvPorts.get(0) != null) {
                  ...
                  if (dvPortConfigInfo != null) {
                     ...
                     portSecurityPolicy = new DVSSecurityPolicy();
                     portSecurityPolicy.setAllowPromiscuous(DVSUtil.getBoolPolicy(
                              false, false));
                     portSecurityPolicy.setForgedTransmits(DVSUtil.getBoolPolicy(
                              false, false));
                     portSecurityPolicy.setMacChanges(DVSUtil.getBoolPolicy(
                              false, false));
                     dvsPortSetting.setSecurityPolicy(portSecurityPolicy);
               ...
               if (this.iDVSwitch.reconfigurePort(dvsMor,
                  ...
                  if (this.dvPortgroupMorList != null
                     ...
                     log.info("Failed to add the portgroup");
                  }
               } else {
         ...
         if (dvPorts != null && dvPorts.get(0) != null) {
            ...
            if (dvPortConfigInfo != null) {
               ...
               portSecurityPolicy = DVSUtil.getDVSSecurityPolicy(false, false,
                        false, false);
               /* portSecurityPolicy.setAllowPromiscuous(DVSUtil.getBoolPolicy(false, false));
                portSecurityPolicy.setForgedTransmits(DVSUtil.getBoolPolicy(false, false));
                portSecurityPolicy.setMacChanges(DVSUtil.getBoolPolicy(false, false));*/
               dvsPortSetting.setSecurityPolicy(portSecurityPolicy);

               /*    inShapingPolicy =  dvPortSetting.getInShapingPolicy();
                   if(inShapingPolicy == null) {
                      inShapingPolicy =
                         DVSUtil.getTrafficShapingPolicy(
                                  false,
                                  true,
                                  null,
                                  new Long(-1),
                      ...
                      inShapingPolicy.setEnabled(
                               DVSUtil.getBoolPolicy(false, true));
                      inShapingPolicy.setPeakBandwidth(
                               DVSUtil.getLongPolicy(false, new Long(-1)));
                   }
      ...
      throws Exception
   {
      ...
      DVSSecurityPolicy portgroupSecurityPolicy = null;
      try {
         dvPortgroupSetting = (VMwareDVSPortSetting) this.iDVSwitch.getConfig(
                  dvsMor).getDefaultPortConfig();
         portgroupSecurityPolicy = dvPortgroupSetting.getSecurityPolicy();
         ...
         dvPortgroupSetting.setSecurityPolicy(portgroupSecurityPolicy);
