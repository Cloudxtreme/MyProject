...
public class Neg003 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Reconfigure a portgroup on an existing "
               + "distributed virtual switch with empty portgroup " + "MOR");
   }
    ...
    * switch with an empty portgroup MOR
    * 
    * @param connectAnchor ConnectAnchor object
    */
      ...
      throws Exception
   {
      ...
      try {
         ...
         if (dvPortgroupMorList != null && dvPortgroupMorList.size() > 0) {
            ...
            if (this.iDVPortgroup.reconfigure(new ManagedObjectReference(),
