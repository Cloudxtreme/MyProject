...
/**
 * Reconfigure a portgroup to an existing distributed virtual switch with scope
 * set to VMFolder mor
 */
         ...
         if (this.dcMor != null && this.hostMor != null) {
            ...
            if (dvsMor != null) {
               ...
               if (nsMor != null) {
                  ...
                  if (this.vmMor != null) {
                     this.folderMor = this.iVirtualMachine.getParentNode(this.vmMor);
                     ...
                     if (this.iVirtualMachine.setVMState(vmMor, VirtualMachinePowerState.POWERED_OFF, false)) {
                        ...
                        if (this.dvPortgroupMorList != null
                           ...
                           log.info("Successfully added the "
                                    + "portgroup");
                           log.info("Portgroup name: "
                                    + this.iDVPortgroup.getName(dvPortgroupMorList.get(0)));
