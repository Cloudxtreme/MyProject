...
public class Pos014 extends TestBase
{
         ...
         if (this.iComputeResource.getAllComputeResources() != null
            ...
            if (this.dcMor != null && this.computeResourceMor != null) {
               ...
               if (this.hostMor != null) {
                  ...
                  this.isEesx = this.iHostSystem.isEsxHost(hostMor);
      ...
      throws Exception
   {
      ...
      try {
         ...
         this.dvPortgroupConfigSpec.getScope().addAll(com.vmware.vcqa.util.TestUtil.arrayToVector(new ManagedObjectReference[] { this.computeResourceMor }));
