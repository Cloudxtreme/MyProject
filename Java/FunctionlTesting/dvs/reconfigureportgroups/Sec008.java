 ...
 * switch as a user not having DVPortgroup.Modify privilege at root folder with
 ...
 * TEST:<br>
 * 4. Reconfigure the port-group. VC should throw NoPermission exception with
 * DVPortgroup.Modify privilege.<br>
 * CLEANUP:<br>
 * 5. Logout test user, remove roles and login as administrator<br>
 * 6. Remove port-groups and DVS.<br>
 */
public class Sec008 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Reconfigure a portgroup on an existing"
               ...
               + "DVPortgroup.Modify privilege at root folder with"
               + " propagate as true");
   }
   ...
   @Test(description = "Reconfigure a portgroup on an existing"
               + "distributed virtual switch as a user noy having "
               + "DVPortgroup.Modify privilege at root folder with"
               + " propagate as true")
   public void test()
      throws Exception
   ...
   public MethodFault getExpectedMethodFault()
   {
      ...
      expectedMethodFault.setPrivilegeId(DVPORTGROUP_MODIFY);
