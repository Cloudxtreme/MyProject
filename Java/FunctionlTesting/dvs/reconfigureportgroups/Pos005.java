 ...
 * with a valid number of ports which is equal to the maximum number of ports in
 * the dvswitch
 */
public class Pos005 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Reconfigure an existing portgroup on an existing "
               ...
               + "ports which is equal to the maximum number of "
               + "ports in the dvswitch");
   }
      ...
      throws Exception
   {
      ...
      try {
         ...
         if (this.rootFolderMor != null) {
            ...
            this.dvsConfigSpec.setMaxPorts(DVSTestConstants.DVS_MAX_PORTS_VALUE);
    ...
    * with a valid number of ports which is less than the maximum number of
    * ports in the distributed virtual switch
    * 
    * @param connectAnchor ConnectAnchor object
    */
      ...
      throws Exception
   {
      ...
      try {
         if (dvPortgroupMorList != null && dvPortgroupMorList.size() > 0) {
            ...
            this.dvPortgroupConfigSpec.setNumPorts(DVSTestConstants.DVS_MAX_PORTS_VALUE);
            this.dvPortgroupConfigSpec.setType(DVSTestConstants.DVPORTGROUP_TYPE_EARLY_BINDING);
