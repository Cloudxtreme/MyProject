 ...
 * switch with scope set to a resource pool Mor and reconfigure a VM on the host
...
public class Neg015 extends TestBase
{
      ...
      throws Exception
   {
      ...
      try {
         ...
         this.secondHostmor = this.iHostSystem.getAllHost().get(1);
         this.resourcePoolMor = this.iHostSystem.getResourcePool(
                  this.secondHostmor).get(0);
         /*
         ...
         if (hostMor != null) {
            if (this.dcMor != null && this.resourcePoolMor != null) {
