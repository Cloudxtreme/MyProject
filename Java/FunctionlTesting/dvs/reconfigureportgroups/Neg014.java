 ...
 * switch with scope set to a folder Mor and reconfigure a VM on the host to
 * connect its VNIC to this portgroup
 */
public class Neg014 extends TestBase
{
      ...
      throws Exception
   {
      ...
      try {
         ...
         this.folderMor = this.iFolder.createFolder(this.rootFolderMor,
                  "myFolder");
         /*
    ...
    * folder MOR and reconfigures a VM-vnic to connect to this portgroup
    * 
    * @param connectAnchor ConnectAnchor object
    */
      ...
      throws Exception
   {
      ...
      try {
         ...
         this.dvPortgroupConfigSpec.getScope().addAll(com.vmware.vcqa.util.TestUtil.arrayToVector(new ManagedObjectReference[] { this.folderMor }));
         ...
         DvsScopeViolated expectedMethodFault = new DvsScopeViolated();
      ...
      throws Exception
   {
      ...
      try {
          ...
          */
         status &= this.iFolder.destroy(this.folderMor);
         /*
