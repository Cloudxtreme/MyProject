 ...
 * with "settingSecurityPolicyOverrideAllowed" set to false
 */
public class Neg037 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Move a port into the portgroup with the blocked "
               ...
               + "settingSecurityPolicyOverrideAllowed set to false");
   }
         ...
         if (rootFolderMor != null) {
            ...
            if (dvsMor != null) {
               ...
               if (portKey != null) {
                  ...
                  settingsMap.put(
                           DVSTestConstants.SECURITY_POLICY_KEY,
      ...
      throws Exception
   {
      ...
      try {
         if (dvPortgroupMorList != null && dvPortgroupMorList.size() > 0) {
            ...
            portgroupSetting = (VMwareDVSPortSetting) iDVSwitch.getConfig(
            ...
            if (portgroupSecurityPolicy == null) {
               ...
               portgroupSecurityPolicy.setForgedTransmits(DVSUtil.getBoolPolicy(
                        false, Boolean.TRUE));
               portgroupSecurityPolicy.setMacChanges(DVSUtil.getBoolPolicy(
                        false, Boolean.TRUE));
            }
            settingsMap = new HashMap<String, Object>();
