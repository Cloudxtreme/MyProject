...
public class Neg004 extends TestBase
{
   ...
   public void setTestDescription()
   {
      setTestDescription("Reconfigure a portgroup on an existing "
               + "distributed virtual switch with a folder " + "MOR");
   }
      ...
      throws Exception
   {
      ...
      try {
         ...
         if (dvPortgroupMorList != null && dvPortgroupMorList.size() > 0) {
            ...
            if (this.iDVPortgroup.reconfigure(rootFolderMor,
         ...
         MethodFault expectedMethodFault = new InvalidProperty();
