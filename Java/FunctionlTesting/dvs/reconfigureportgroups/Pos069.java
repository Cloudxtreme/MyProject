...
/**
 * DESCRIPTION:Associate/Disassociate a newly created nrp with a dvPortgroup<BR>
 * TARGET: VC <BR>
 * SETUP:<BR>
 * 1. Create a vDS<BR>
 * 2. Enable netiorm <BR>
 ...
 */
public class Pos069 extends TestBase
{
      ...
      throws Exception
   {
      ...
      nrp = NetworkResourcePoolHelper.extractNRPByName(
    ...
    * Test method
    */
   @Test(description = "Associate/Disassociate a newly created nrp with a dvPortgroup")
   public void test()
      throws Exception
   {
      ...
      dvpgconfigInfo = dvpg.getConfigInfo(pgMors.get(0));
      dvpgSpec[0] = dvpg.getConfigSpec(dvpgconfigInfo);
      dvpgSpec[0].setConfigVersion(dvpgconfigInfo.getConfigVersion());
      NetworkResourcePoolHelper.disassociateNrpToDvpgSpec(dvpgSpec[0], nrp);
   ...
   {
      setTestDescription("Associate/Disassociate a newly created nrp with a dvPortgroup");
   }
